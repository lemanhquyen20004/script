...
---------------
local L_1_ =
loadstring(game:HttpGet("https://github.com/dawid-scripts/Fluent/releases/latest/download/main
.lua"))()
local L_2_ =
loadstring(game:HttpGet("https://raw.githubusercontent.com/dawid-scripts/Fluent/master/Addon
s/SaveManager.lua"))()
local L_3_ =
loadstring(game:HttpGet("https://raw.githubusercontent.com/dawid-scripts/Fluent/master/Addon
s/InterfaceManager.lua"))()
-------------------------------------------------------------------------------------------------------------------------------
---------------
...
--Flag Player
function AntiBan()
for L_116_forvar0, L_117_forvar1 in
pairs(game:GetService("Players").LocalPlayer.Character:GetDescendants()) do
if L_117_forvar1:IsA("LocalScript") then
if L_117_forvar1.Name == "General" or L_117_forvar1.Name ==
"Shiftlock" or L_117_forvar1.Name == "FallDamage" or L_117_forvar1.Name == "4444" or
L_117_forvar1.Name == "CamBob" or L_117_forvar1.Name == "JumpCD" or
L_117_forvar1.Name == "Looking" or L_117_forvar1.Name == "Run" then
L_117_forvar1:Destroy()
end
end
end
for L_118_forvar0, L_119_forvar1 in
pairs(game:GetService("Players").LocalPlayer.PlayerScripts:GetDescendants()) do
if L_119_forvar1:IsA("LocalScript") then
if L_119_forvar1.Name == "RobloxMotor6DBugFix" or
L_119_forvar1.Name == "Clans" or L_119_forvar1.Name == "Codes" or L_119_forvar1.Name
== "CustomForceField" or L_119_forvar1.Name == "MenuBloodSp" or L_119_forvar1.Name ==
"PlayerList" then
...
if First_Sea then
if L_120_ == 1 or L_120_ <= 9 or SelectMonster == "Bandit" or
SelectArea == '' then -- Bandit
Ms = "Bandit"
...
1547.7841796875)
CFrameMon = CFrame.new(1038.5533447266,
41.296249389648, 1576.5098876953)
elseif L_120_ == 10 or L_120_ <= 14 or SelectMonster == "Monkey" or
SelectArea == 'Jungle' then -- Monkey
Ms = "Monkey"
...
153.38809204102)
CFrameMon = CFrame.new(- 1448.1446533203,
50.851993560791, 63.60718536377)
elseif L_120_ == 15 or L_120_ <= 29 or SelectMonster == "Gorilla" or
SelectArea == 'Jungle' then -- Gorilla
Ms = "Gorilla"
NameQuest = "JungleQuest"
QuestLv = 2
NameMon = "Gorilla"
CFrameQ = CFrame.new(- 1601.6553955078, 36.85213470459,
153.38809204102)
CFrameMon = CFrame.new(- 1142.6488037109,
40.462348937988, - 515.39227294922)
elseif L_120_ == 30 or L_120_ <= 39 or SelectMonster == "Pirate" or
SelectArea == 'Buggy' then -- Pirate
Ms = "Pirate"
...
3827.4057617188)
CFrameMon = CFrame.new(- 1201.0881347656,
40.628940582275, 3857.5966796875)
elseif L_120_ == 40 or L_120_ <= 59 or SelectMonster == "Brute" or
SelectArea == 'Buggy' then -- Brute
Ms = "Brute"
NameQuest = "BuggyQuest1"
QuestLv = 2
NameMon = "Brute"
CFrameQ = CFrame.new(- 1140.1761474609, 4.752049446106,
3827.4057617188)
CFrameMon = CFrame.new(- 1387.5324707031,
24.592035293579, 4100.9575195313)
elseif L_120_ == 60 or L_120_ <= 74 or SelectMonster == "Desert Bandit"
or SelectArea == 'Desert' then -- Desert Bandit
Ms = "Desert Bandit"
...
4390.1494140625)
CFrameMon = CFrame.new(984.99896240234,
16.109552383423, 4417.91015625)
elseif L_120_ == 75 or L_120_ <= 89 or SelectMonster == "Desert
Officer" or SelectArea == 'Desert' then -- Desert Officer
Ms = "Desert Officer"
NameQuest = "DesertQuest"
QuestLv = 2
...
CFrameQ = CFrame.new(896.51721191406, 6.4384617805481,
4390.1494140625)
CFrameMon = CFrame.new(1547.1510009766,
14.452038764954, 4381.8002929688)
elseif L_120_ == 90 or L_120_ <= 99 or SelectMonster == "Snow Bandit"
or SelectArea == 'Snow' then -- Snow Bandit
Ms = "Snow Bandit"
NameQuest = "SnowQuest"
QuestLv = 1
NameMon = "Snow Bandit"
...
1298.3576660156)
CFrameMon = CFrame.new(1356.3028564453,
105.76865386963, - 1328.2418212891)
elseif L_120_ == 100 or L_120_ <= 119 or SelectMonster == "Snowman"
or SelectArea == 'Snow' then -- Snowman
Ms = "Snowman"
NameQuest = "SnowQuest"
QuestLv = 2
NameMon = "Snowman"
CFrameQ = CFrame.new(1386.8073730469, 87.272789001465, -
1298.3576660156)
CFrameMon = CFrame.new(1218.7956542969,
138.01184082031, - 1488.0262451172)
elseif L_120_ == 120 or L_120_ <= 149 or SelectMonster == "Chief Petty
Officer" or SelectArea == 'Marine' then -- Chief Petty Officer
...
4324.1840820313)
CFrameMon = CFrame.new(- 4931.1552734375,
65.793113708496, 4121.8393554688)
elseif L_120_ == 150 or L_120_ <= 174 or SelectMonster == "Sky Bandit"
or SelectArea == 'Sky' then -- Sky Bandit
Ms = "Sky Bandit"
NameQuest = "SkyQuest"
QuestLv = 1
NameMon = "Sky Bandit"
...
- 2623.0483398438)
CFrameMon = CFrame.new(- 4955.6411132813,
365.46365356445, - 2908.1865234375)
elseif L_120_ == 175 or L_120_ <= 189 or SelectMonster == "Dark
Master" or SelectArea == 'Sky' then -- Dark Master
Ms = "Dark Master"
NameQuest = "SkyQuest"
QuestLv = 2
NameMon = "Dark Master"
CFrameQ = CFrame.new(- 4842.1372070313, 717.69543457031,
- 2623.0483398438)
CFrameMon = CFrame.new(- 5148.1650390625,
439.04571533203, - 2332.9611816406)
elseif L_120_ == 190 or L_120_ <= 209 or SelectMonster == "Prisoner" or
SelectArea == 'Prison' then -- Prisoner
Ms = "Prisoner"
...
CFrameMon = CFrame.new(4937.31885, 0.332031399,
649.574524, 0.694649816, 0, - 0.719348073, 0, 1, 0, 0.719348073, 0, 0.694649816)
elseif L_120_ == 210 or L_120_ <= 249 or SelectMonster == "Dangerous
Prisoner" or SelectArea == 'Prison' then -- Dangerous Prisoner
...
0.898906827, 0, - 0.438139856, 0, 1, 0, 0.438139856, 0, 0.898906827)
elseif L_120_ == 250 or L_120_ <= 274 or SelectMonster == "Toga
Warrior" or SelectArea == 'Colosseum' then -- Toga Warrior
Ms = "Toga Warrior"
...
2984.4838867188)
CFrameMon = CFrame.new(- 1872.5166015625,
49.080215454102, - 2913.810546875)
elseif L_120_ == 275 or L_120_ <= 299 or SelectMonster == "Gladiator"
or SelectArea == 'Colosseum' then -- Gladiator
Ms = "Gladiator"
NameQuest = "ColosseumQuest"
QuestLv = 2
NameMon = "Gladiator"
CFrameQ = CFrame.new(- 1577.7890625, 7.4151420593262, -
2984.4838867188)
CFrameMon = CFrame.new(- 1521.3740234375,
81.203170776367, - 3066.3139648438)
elseif L_120_ == 300 or L_120_ <= 324 or SelectMonster == "Military
Soldier" or SelectArea == 'Magma' then -- Military Soldier
Ms = "Military Soldier"
...
8517.00390625)
CFrameMon = CFrame.new(- 5369.0004882813,
61.24352645874, 8556.4921875)
elseif L_120_ == 325 or L_120_ <= 374 or SelectMonster == "Military
Spy" or SelectArea == 'Magma' then -- Military Spy
Ms = "Military Spy"
NameQuest = "MagmaQuest"
QuestLv = 2
...
CFrameQ = CFrame.new(- 5316.1157226563, 12.262831687927,
8517.00390625)
CFrameMon = CFrame.new(- 5787.00293, 75.8262634,
8651.69922, 0.838590562, 0, - 0.544762194, 0, 1, 0, 0.544762194, 0, 0.838590562)
elseif L_120_ == 375 or L_120_ <= 399 or SelectMonster == "Fishman
Warrior" or SelectArea == 'Fishman' then -- Fishman Warrior
Ms = "Fishman Warrior"
NameQuest = "FishmanQuest"
QuestLv = 1
NameMon = "Fishman Warrior"
CFrameQ = CFrame.new(61122.65234375, 18.497442245483,
1569.3997802734)
...
elseif L_120_ == 400 or L_120_ <= 449 or SelectMonster == "Fishman
Commando" or SelectArea == 'Fishman' then -- Fishman Commando
Ms = "Fishman Commando"
NameQuest = "FishmanQuest"
QuestLv = 2
...
elseif L_120_ == 10 or L_120_ <= 474 or SelectMonster == "God's
Guard" or SelectArea == 'Sky Island' then -- God's Guard
Ms = "God's Guard"
...
- 1953.8489990234)
CFrameMon = CFrame.new(- 4628.0498046875,
866.92877197266, - 1931.2352294922)
if _G.AutoLevel and (CFrameMon.Position -
game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 3000 then
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",
Vector3.new(- 4607.82275, 872.54248, - 1667.55688))
end
elseif L_120_ == 475 or L_120_ <= 524 or SelectMonster == "Shanda" or
SelectArea == 'Sky Island' then -- Shanda
Ms = "Shanda"
NameQuest = "SkyExp1Quest"
QuestLv = 2
NameMon = "Shanda"
...
- 378.42266845703)
CFrameMon = CFrame.new(- 7685.1474609375,
5601.0751953125, - 441.38876342773)
if _G.AutoLevel and (CFrameMon.Position -
game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 3000 then
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",
Vector3.new(- 7894.6176757813, 5547.1416015625, - 380.29119873047))
end
elseif L_120_ == 525 or L_120_ <= 549 or SelectMonster == "Royal
Squad" or SelectArea == 'Sky Island' then -- Royal Squad
Ms = "Royal Squad"
...
1410.923828125)
CFrameMon = CFrame.new(- 7654.2514648438,
5637.1079101563, - 1407.7550048828)
elseif L_120_ == 550 or L_120_ <= 624 or SelectMonster == "Royal
Soldier" or SelectArea == 'Sky Island' then -- Royal Soldier
Ms = "Royal Soldier"
NameQuest = "SkyExp2Quest"
QuestLv = 2
...
CFrameQ = CFrame.new(- 7903.3828125, 5635.9897460938, -
1410.923828125)
CFrameMon = CFrame.new(- 7760.4106445313,
5679.9077148438, - 1884.8112792969)
elseif L_120_ == 625 or L_120_ <= 649 or SelectMonster == "Galley
Pirate" or SelectArea == 'Fountain' then -- Galley Pirate
Ms = "Galley Pirate"
NameQuest = "FountainQuest"
QuestLv = 1
NameMon = "Galley Pirate"
CFrameQ = CFrame.new(5258.2788085938, 38.526931762695,
4050.044921875)
CFrameMon = CFrame.new(5557.1684570313,
152.32717895508, 3998.7758789063)
elseif L_120_ >= 650 or SelectMonster == "Galley Captain" or SelectArea
== 'Fountain' then -- Galley Captain
Ms = "Galley Captain"
NameQuest = "FountainQuest"
QuestLv = 2
...
CFrameQ = CFrame.new(5258.2788085938, 38.526931762695,
4050.044921875)
CFrameMon = CFrame.new(5677.6772460938,
92.786109924316, 4966.6323242188)
end
end
if Second_Sea then
if L_120_ == 700 or L_120_ <= 724 or SelectMonster == "Raider" or
SelectArea == 'Area 1' then -- Raider
Ms = "Raider"
...
1835.9426269531)
CFrameMon = CFrame.new(68.874565124512,
93.635643005371, 2429.6752929688)
elseif L_120_ == 725 or L_120_ <= 774 or SelectMonster == "Mercenary"
or SelectArea == 'Area 1' then -- Mercenary
Ms = "Mercenary"
NameQuest = "Area1Quest"
QuestLv = 2
NameMon = "Mercenary"
CFrameQ = CFrame.new(- 427.72567749023, 72.99634552002,
1835.9426269531)
CFrameMon = CFrame.new(- 864.85009765625,
122.47104644775, 1453.1505126953)
elseif L_120_ == 775 or L_120_ <= 799 or SelectMonster == "Swan
Pirate" or SelectArea == 'Area 2' then -- Swan Pirate
Ms = "Swan Pirate"
...
917.81298828125)
CFrameMon = CFrame.new(1065.3669433594,
137.64012145996, 1324.3798828125)
elseif L_120_ == 800 or L_120_ <= 874 or SelectMonster == "Factory
Staff" or SelectArea == 'Area 2' then -- Factory Staff
Ms = "Factory Staff"
NameQuest = "Area2Quest"
QuestLv = 2
...
CFrameQ = CFrame.new(635.61151123047, 73.096351623535,
917.81298828125)
CFrameMon = CFrame.new(533.22045898438,
128.46876525879, 355.62615966797)
elseif L_120_ == 875 or L_120_ <= 899 or SelectMonster == "Marine
Lieutenan" or SelectArea == 'Marine' then -- Marine Lieutenant
...
3217.7082519531)
CFrameMon = CFrame.new(- 2489.2622070313,
84.613594055176, - 3151.8830566406)
elseif L_120_ == 900 or L_120_ <= 949 or SelectMonster == "Marine
Captain" or SelectArea == 'Marine' then -- Marine Captain
Ms = "Marine Captain"
NameQuest = "MarineQuest3"
QuestLv = 2
...
CFrameQ = CFrame.new(- 2440.9934082031, 73.04190826416, -
3217.7082519531)
CFrameMon = CFrame.new(- 2335.2026367188,
79.786659240723, - 3245.8674316406)
elseif L_120_ == 950 or L_120_ <= 974 or SelectMonster == "Zombie" or
SelectArea == 'Zombie' then -- Zombie
Ms = "Zombie"
...
- 794.59094238281)
CFrameMon = CFrame.new(- 5536.4970703125,
101.08577728271, - 835.59075927734)
elseif L_120_ == 975 or L_120_ <= 999 or SelectMonster == "Vampire" or
SelectArea == 'Zombie' then -- Vampire
Ms = "Vampire"
NameQuest = "ZombieQuest"
QuestLv = 2
NameMon = "Vampire"
CFrameQ = CFrame.new(- 5494.3413085938, 48.505931854248,
- 794.59094238281)
CFrameMon = CFrame.new(- 5806.1098632813,
16.722528457642, - 1164.4384765625)
elseif L_120_ == 1000 or L_120_ <= 1049 or SelectMonster == "Snow
Trooper" or SelectArea == 'Snow Mountain' then -- Snow Trooper
Ms = "Snow Trooper"
NameQuest = "SnowMountainQuest"
QuestLv = 1
NameMon = "Snow Trooper"
CFrameQ = CFrame.new(607.05963134766, 401.44781494141, -
5370.5546875)
CFrameMon = CFrame.new(535.21051025391,
432.74209594727, - 5484.9165039063)
elseif L_120_ == 1050 or L_120_ <= 1099 or SelectMonster == "Winter
Warrior" or SelectArea == 'Snow Mountain' then -- Winter Warrior
Ms = "Winter Warrior"
NameQuest = "SnowMountainQuest"
QuestLv = 2
...
CFrameQ = CFrame.new(607.05963134766, 401.44781494141, -
5370.5546875)
CFrameMon = CFrame.new(1234.4449462891,
456.95419311523, - 5174.130859375)
elseif L_120_ == 1100 or L_120_ <= 1124 or SelectMonster == "Lab
Subordinate" or SelectArea == 'Ice Fire' then -- Lab Subordinate
Ms = "Lab Subordinate"
...
4902.0385742188)
CFrameMon = CFrame.new(- 5720.5576171875,
63.309471130371, - 4784.6103515625)
elseif L_120_ == 1125 or L_120_ <= 1174 or SelectMonster == "Horned
Warrior" or SelectArea == 'Ice Fire' then -- Horned Warrior
Ms = "Horned Warrior"
NameQuest = "IceSideQuest"
QuestLv = 2
...
CFrameQ = CFrame.new(- 6061.841796875, 15.926671981812, -
4902.0385742188)
CFrameMon = CFrame.new(- 6292.751953125,
91.181983947754, - 5502.6499023438)
elseif L_120_ == 1175 or L_120_ <= 1199 or SelectMonster == "Magma
Ninja" or SelectArea == 'Ice Fire' then -- Magma Ninja
Ms = "Magma Ninja"
...
- 5297.9614257813)
CFrameMon = CFrame.new(- 5461.8388671875,
130.36347961426, - 5836.4702148438)
elseif L_120_ == 1200 or L_120_ <= 1249 or SelectMonster == "Lava
Pirate" or SelectArea == 'Ice Fire' then -- Lava Pirate
Ms = "Lava Pirate"
NameQuest = "FireSideQuest"
QuestLv = 2
NameMon = "Lava Pirate"
CFrameQ = CFrame.new(- 5429.0473632813, 15.977565765381,
- 5297.9614257813)
CFrameMon = CFrame.new(- 5251.1889648438,
55.164535522461, - 4774.4096679688)
elseif L_120_ == 1250 or L_120_ <= 1274 or SelectMonster == "Ship
Deckhand" or SelectArea == 'Ship' then -- Ship Deckhand
Ms = "Ship Deckhand"
NameQuest = "ShipQuest1"
QuestLv = 1
NameMon = "Ship Deckhand"
CFrameQ = CFrame.new(1040.2927246094, 125.08293151855,
32911.0390625)
CFrameMon = CFrame.new(921.12365722656, 125.9839553833,
33088.328125)
if _G.AutoLevel and (CFrameMon.Position -
game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 20000 then
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",
Vector3.new(923.21252441406, 126.9760055542, 32852.83203125))
end
elseif L_120_ == 1275 or L_120_ <= 1299 or SelectMonster == "Ship
Engineer" or SelectArea == 'Ship' then -- Ship Engineer
Ms = "Ship Engineer"
NameQuest = "ShipQuest1"
QuestLv = 2
...
elseif L_120_ == 1300 or L_120_ <= 1324 or SelectMonster == "Ship
Steward" or SelectArea == 'Ship' then -- Ship Steward
Ms = "Ship Steward"
NameQuest = "ShipQuest2"
QuestLv = 1
NameMon = "Ship Steward"
CFrameQ = CFrame.new(971.42065429688, 125.08293151855,
33245.54296875)
CFrameMon = CFrame.new(943.85504150391,
129.58183288574, 33444.3671875)
if _G.AutoLevel and (CFrameMon.Position -
game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 20000 then
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",
Vector3.new(923.21252441406, 126.9760055542, 32852.83203125))
end
elseif L_120_ == 1325 or L_120_ <= 1349 or SelectMonster == "Ship
Officer" or SelectArea == 'Ship' then -- Ship Officer
Ms = "Ship Officer"
NameQuest = "ShipQuest2"
QuestLv = 2
...
CFrameQ = CFrame.new(971.42065429688, 125.08293151855,
33245.54296875)
CFrameMon = CFrame.new(955.38458251953,
181.08335876465, 33331.890625)
if _G.AutoLevel and (CFrameMon.Position -
game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 20000 then
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",
Vector3.new(923.21252441406, 126.9760055542, 32852.83203125))
end
elseif L_120_ == 1350 or L_120_ <= 1374 or SelectMonster == "Arctic
Warrior" or SelectArea == 'Frost' then -- Arctic Warrior
Ms = "Arctic Warrior"
...
elseif L_120_ == 1375 or L_120_ <= 1424 or SelectMonster == "Snow
Lurker" or SelectArea == 'Frost' then -- Snow Lurker
Ms = "Snow Lurker"
NameQuest = "FrostQuest"
QuestLv = 2
NameMon = "Snow Lurker"
...
- 6618.3481445313)
elseif L_120_ == 1425 or L_120_ <= 1449 or SelectMonster == "Sea
Soldier" or SelectArea == 'Forgotten' then -- Sea Soldier
Ms = "Sea Soldier"
...
- 10147.790039063)
CFrameMon = CFrame.new(- 3185.0153808594,
58.789089202881, - 9663.6064453125)
elseif L_120_ >= 1450 or SelectMonster == "Water Fighter" or SelectArea
== 'Forgotten' then -- Water Fighter
Ms = "Water Fighter"
NameQuest = "ForgottenQuest"
QuestLv = 2
...
CFrameQ = CFrame.new(- 3054.5827636719, 236.87213134766,
- 10147.790039063)
CFrameMon = CFrame.new(- 3262.9301757813,
298.69036865234, - 10552.529296875)
end
end
if Third_Sea then
if L_120_ == 1500 or L_120_ <= 1524 or SelectMonster == "Pirate
Millionaire" or SelectArea == 'Pirate Port' then -- Pirate Millionaire
...
5580.0903320313)
CFrameMon = CFrame.new(- 435.68109130859,
189.69866943359, 5551.0756835938)
elseif L_120_ == 1525 or L_120_ <= 1574 or SelectMonster == "Pistol
Billionaire" or SelectArea == 'Pirate Port' then -- Pistol Billoonaire
...
CFrameQ = CFrame.new(- 289.61752319336, 43.819011688232,
5580.0903320313)
CFrameMon = CFrame.new(- 236.53652954102,
217.46676635742, 6006.0883789063)
elseif L_120_ == 1575 or L_120_ <= 1599 or SelectMonster == "Dragon
Crew Warrior" or SelectArea == 'Amazon' then -- Dragon Crew Warrior
Ms = "Dragon Crew Warrior"
NameQuest = "AmazonQuest"
QuestLv = 1
NameMon = "Dragon Crew Warrior"
CFrameQ = CFrame.new(5833.1147460938, 51.60498046875, -
1103.0693359375)
CFrameMon = CFrame.new(6301.9975585938,
104.77153015137, - 1082.6075439453)
elseif L_120_ == 1600 or L_120_ <= 1624 or SelectMonster == "Dragon
Crew Archer" or SelectArea == 'Amazon' then -- Dragon Crew Archer
...
CFrameQ = CFrame.new(5833.1147460938, 51.60498046875, -
1103.0693359375)
CFrameMon = CFrame.new(6831.1171875, 441.76708984375,
446.58615112305)
elseif L_120_ == 1625 or L_120_ <= 1649 or SelectMonster == "Female
Islander" or SelectArea == 'Amazon' then -- Female Islander
Ms = "Female Islander"
...
749.45672607422)
CFrameMon = CFrame.new(5792.5166015625,
848.14392089844, 1084.1818847656)
elseif L_120_ == 1650 or L_120_ <= 1699 or SelectMonster == "Giant
Islander" or SelectArea == 'Amazon' then -- Giant Islander
Ms = "Giant Islander"
NameQuest = "AmazonQuest2"
QuestLv = 2
...
CFrameQ = CFrame.new(5446.8793945313, 601.62945556641,
749.45672607422)
CFrameMon = CFrame.new(5009.5068359375,
664.11071777344, - 40.960144042969)
elseif L_120_ == 1700 or L_120_ <= 1724 or SelectMonster == "Marine
Commodore" or SelectArea == 'Marine Tree' then -- Marine Commodore
Ms = "Marine Commodore"
...
6740.0551757813)
CFrameMon = CFrame.new(2198.0063476563,
128.71075439453, - 7109.5043945313)
elseif L_120_ == 1725 or L_120_ <= 1774 or SelectMonster == "Marine
Rear Admiral" or SelectArea == 'Marine Tree' then -- Marine Rear Admiral
...
CFrameQ = CFrame.new(2179.98828125, 28.731239318848, -
6740.0551757813)
CFrameMon = CFrame.new(3294.3142089844,
385.41125488281, - 7048.6342773438)
elseif L_120_ == 1775 or L_120_ <= 1799 or SelectMonster == "Fishman
Raider" or SelectArea == 'Deep Forest' then -- Fishman Raide
Ms = "Fishman Raider"
...
- 8757.666015625)
CFrameMon = CFrame.new(- 10553.268554688,
521.38439941406, - 8176.9458007813)
elseif L_120_ == 1800 or L_120_ <= 1824 or SelectMonster == "Fishman
Captain" or SelectArea == 'Deep Forest' then -- Fishman Captain
Ms = "Fishman Captain"
NameQuest = "DeepForestIsland3"
QuestLv = 2
...
- 8759.4638671875)
CFrameMon = CFrame.new(- 10789.401367188,
427.18637084961, - 9131.4423828125)
elseif L_120_ == 1825 or L_120_ <= 1849 or SelectMonster == "Forest
Pirate" or SelectArea == 'Deep Forest' then -- Forest Pirate
Ms = "Forest Pirate"
...
- 7626.4819335938)
CFrameMon = CFrame.new(- 13489.397460938,
400.30349731445, - 7770.251953125)
elseif L_120_ == 1850 or L_120_ <= 1899 or SelectMonster ==
"Mythological Pirate" or SelectArea == 'Deep Forest' then -- Mythological Pirate
...
CFrameQ = CFrame.new(- 13232.662109375, 332.40396118164,
- 7626.4819335938)
CFrameMon = CFrame.new(- 13508.616210938,
582.46228027344, - 6985.3037109375)
elseif L_120_ == 1900 or L_120_ <= 1924 or SelectMonster == "Jungle
Pirate" or SelectArea == 'Deep Forest' then -- Jungle Pirate
Ms = "Jungle Pirate"
...
- 9902.1240234375)
CFrameMon = CFrame.new(- 12267.103515625,
459.75262451172, - 10277.200195313)
elseif L_120_ == 1925 or L_120_ <= 1974 or SelectMonster ==
"Musketeer Pirate" or SelectArea == 'Deep Forest' then -- Musketeer Pirate
Ms = "Musketeer Pirate"
NameQuest = "DeepForestIsland2"
QuestLv = 2
...
- 9904.638671875)
elseif L_120_ == 1975 or L_120_ <= 1999 or SelectMonster == "Reborn
Skeleton" or SelectArea == 'Haunted Castle' then
Ms = "Reborn Skeleton"
...
CFrameMon = CFrame.new(- 8761.77148, 183.431747,
6168.33301, 0.978073597, - 1.3950732e-05, - 0.208259016, - 1.08073925e-06, 1, -
7.20630269e-05, 0.208259016, 7.07080399e-05, 0.978073597)
elseif L_120_ == 2000 or L_120_ <= 2024 or SelectMonster == "Living
Zombie" or SelectArea == 'Haunted Castle' then
Ms = "Living Zombie"
NameQuest = "HauntedQuest1"
QuestLv = 2
...
- 0.00655503059, 4.52954225e-08, - 0.999978542, 2.04920472e-08, 1, 4.51620679e-08,
0.999978542, - 2.01955679e-08, - 0.00655503059)
CFrameMon = CFrame.new(- 10103.7529, 238.565979,
6179.75977, 0.999474227, 2.77547141e-08, 0.0324240364, - 2.58006327e-08, 1, -
6.06848474e-08, - 0.0324240364, 5.98163865e-08, 0.999474227)
elseif L_120_ == 2025 or L_120_ <= 2049 or SelectMonster == "Demonic
Soul" or SelectArea == 'Haunted Castle' then
Ms = "Demonic Soul"
...
6078.4653320313)
CFrameMon = CFrame.new(- 9712.03125, 204.69589233398,
6193.322265625)
elseif L_120_ == 2050 or L_120_ <= 2074 or SelectMonster ==
"Posessed Mummy" or SelectArea == 'Haunted Castle' then
Ms = "Posessed Mummy"
NameQuest = "HauntedQuest2"
QuestLv = 2
...
CFrameQ = CFrame.new(- 9516.9931640625, 178.00651550293,
6078.4653320313)
CFrameMon = CFrame.new(- 9545.7763671875,
69.619895935059, 6339.5615234375)
elseif L_120_ == 2075 or L_120_ <= 2099 or SelectMonster == "Peanut
Scout" or SelectArea == 'Nut Island' then
Ms = "Peanut Scout"
NameQuest = "NutsIslandQuest"
QuestLv = 1
NameMon = "Peanut Scout"
CFrameQ = CFrame.new(- 2105.53198, 37.2495995, -
10195.5088, - 0.766061664, 0, - 0.642767608, 0, 1, 0, 0.642767608, 0, - 0.766061664)
CFrameMon = CFrame.new(- 2150.587890625,
122.49767303467, - 10358.994140625)
elseif L_120_ == 2100 or L_120_ <= 2124 or SelectMonster == "Peanut
President" or SelectArea == 'Nut Island' then
Ms = "Peanut President"
NameQuest = "NutsIslandQuest"
QuestLv = 2
...
CFrameMon = CFrame.new(- 2150.587890625,
122.49767303467, - 10358.994140625)
elseif L_120_ == 2125 or L_120_ <= 2149 or SelectMonster == "Ice
Cream Chef" or SelectArea == 'Ice Cream Island' then
Ms = "Ice Cream Chef"
NameQuest = "IceCreamIslandQuest"
QuestLv = 1
NameMon = "Ice Cream Chef"
CFrameQ = CFrame.new(- 819.376709, 64.9259796, -
10967.2832, - 0.766061664, 0, 0.642767608, 0, 1, 0, - 0.642767608, 0, - 0.766061664)
CFrameMon = CFrame.new(- 789.941528, 209.382889, -
11009.9805, - 0.0703101531, 0, - 0.997525156, 0, 1.00000012, 0, 0.997525275, 0, -
0.0703101456)
elseif L_120_ == 2150 or L_120_ <= 2199 or SelectMonster == "Ice
Cream Commander" or SelectArea == 'Ice Cream Island' then
...
11009.9805, - 0.0703101531, 0, - 0.997525156, 0, 1.00000012, 0, 0.997525275, 0, -
0.0703101456)
elseif L_120_ == 2200 or L_120_ <= 2224 or SelectMonster == "Cookie
Crafter" or SelectArea == 'Cake Island' then
Ms = "Cookie Crafter"
NameQuest = "CakeQuest1"
QuestLv = 1
NameMon = "Cookie Crafter"
CFrameQ = CFrame.new(- 2022.29858, 36.9275894, -
12030.9766, - 0.961273909, 0, - 0.275594592, 0, 1, 0, 0.275594592, 0, - 0.961273909)
CFrameMon = CFrame.new(- 2321.71216, 36.699482, -
12216.7871, - 0.780074954, 0, 0.625686109, 0, 1, 0, - 0.625686109, 0, - 0.780074954)
elseif L_120_ == 2225 or L_120_ <= 2249 or SelectMonster == "Cake
Guard" or SelectArea == 'Cake Island' then
Ms = "Cake Guard"
NameQuest = "CakeQuest1"
QuestLv = 2
NameMon = "Cake Guard"
CFrameQ = CFrame.new(- 2022.29858, 36.9275894, -
12030.9766, - 0.961273909, 0, - 0.275594592, 0, 1, 0, 0.275594592, 0, - 0.961273909)
CFrameMon = CFrame.new(- 1418.11011, 36.6718941, -
12255.7324, 0.0677844882, 0, 0.997700036, 0, 1, 0, - 0.997700036, 0, 0.0677844882)
elseif L_120_ == 2250 or L_120_ <= 2274 or SelectMonster == "Baking
Staff" or SelectArea == 'Cake Island' then
Ms = "Baking Staff"
NameQuest = "CakeQuest2"
QuestLv = 1
NameMon = "Baking Staff"
CFrameQ = CFrame.new(- 1928.31763, 37.7296638, -
12840.626, 0.951068401, 0, - 0.308980465, 0, 1, 0, 0.308980465, 0, 0.951068401)
CFrameMon = CFrame.new(- 1980.43848, 36.6716766, -
12983.8418, - 0.254443765, 0, - 0.967087567, 0, 1, 0, 0.967087567, 0, - 0.254443765)
elseif L_120_ == 2275 or L_120_ <= 2299 or SelectMonster == "Head
Baker" or SelectArea == 'Cake Island' then
Ms = "Head Baker"
NameQuest = "CakeQuest2"
QuestLv = 2
NameMon = "Head Baker"
CFrameQ = CFrame.new(- 1928.31763, 37.7296638, -
12840.626, 0.951068401, 0, - 0.308980465, 0, 1, 0, 0.308980465, 0, 0.951068401)
CFrameMon = CFrame.new(- 2251.5791, 52.2714615, -
13033.3965, - 0.991971016, 0, - 0.126466095, 0, 1, 0, 0.126466095, 0, - 0.991971016)
elseif L_120_ == 2300 or L_120_ <= 2324 or SelectMonster == "Cocoa
Warrior" or SelectArea == 'Choco Island' then
Ms = "Cocoa Warrior"
NameQuest = "ChocQuest1"
QuestLv = 1
NameMon = "Cocoa Warrior"
CFrameQ = CFrame.new(231.75, 23.9003029, - 12200.292, -1, 0,
0, 0, 1, 0, 0, 0, -1)
CFrameMon = CFrame.new(167.978516, 26.2254658, -
12238.874, - 0.939700961, 0, 0.341998369, 0, 1, 0, - 0.341998369, 0, - 0.939700961)
elseif L_120_ == 2325 or L_120_ <= 2349 or SelectMonster ==
"Chocolate Bar Battler" or SelectArea == 'Choco Island' then
...
CFrameQ = CFrame.new(231.75, 23.9003029, - 12200.292, -1, 0,
0, 0, 1, 0, 0, 0, -1)
CFrameMon = CFrame.new(701.312073, 25.5824986, -
12708.2148, - 0.342042685, 0, - 0.939684391, 0, 1, 0, 0.939684391, 0, - 0.342042685)
elseif L_120_ == 2350 or L_120_ <= 2374 or SelectMonster == "Sweet
Thief" or SelectArea == 'Choco Island' then
Ms = "Sweet Thief"
...
CFrameMon = CFrame.new(- 140.258301, 25.5824986, -
12652.3115, 0.173624337, 0, - 0.984811902, 0, 1, 0, 0.984811902, 0, 0.173624337)
elseif L_120_ == 2375 or L_120_ <= 2400 or SelectMonster == "Candy
Rebel" or SelectArea == 'Choco Island' then
Ms = "Candy Rebel"
NameQuest = "ChocQuest2"
QuestLv = 2
NameMon = "Candy Rebel"
CFrameQ = CFrame.new(151.198242, 23.8907146, - 12774.6172,
0.422592998, 0, 0.906319618, 0, 1, 0, - 0.906319618, 0, 0.422592998)
CFrameMon = CFrame.new(47.9231453, 25.5824986, -
13029.2402, - 0.819156051, 0, - 0.573571265, 0, 1, 0, 0.573571265, 0, - 0.819156051)
elseif L_120_ == 2400 or L_120_ <= 2424 or SelectMonster == "Candy
Pirate" or SelectArea == 'Candy Island' then
Ms = "Candy Pirate"
...
CFrameMon = CFrame.new(- 1437.56348, 17.1481285, -
14385.6934, 0.173624337, 0, - 0.984811902, 0, 1, 0, 0.984811902, 0, 0.173624337)
elseif L_120_ == 2425 or L_120_ <= 2449 or SelectMonster == "Snow
Demon" or SelectArea == 'Candy Island' then
Ms = "Snow Demon"
NameQuest = "CandyQuest1"
QuestLv = 2
NameMon = "Snow Demon"
CFrameQ = CFrame.new(- 1149.328, 13.5759039, - 14445.6143, -
0.156446099, 0, - 0.987686574, 0, 1, 0, 0.987686574, 0, - 0.156446099)
CFrameMon = CFrame.new(- 916.222656, 17.1481285, -
14638.8125, 0.866007268, 0, 0.500031412, 0, 1, 0, - 0.500031412, 0, 0.866007268)
elseif L_120_ == 2450 or L_120_ <= 2474 or SelectMonster == "Isle
Outlaw" or SelectArea == 'Tiki Outpost' then
Ms = "Isle Outlaw"
...
179.91360473632812)
CFrameMon = CFrame.new(- 16162.8193359375,
11.6863374710083, - 96.45481872558594)
elseif L_120_ == 2475 or L_120_ <= 2524 or SelectMonster == "Island
Boy" or SelectArea == 'Tiki Outpost' then
Ms = "Island Boy"
NameQuest = "TikiQuest1"
QuestLv = 2
NameMon = "Island Boy"
CFrameQ = CFrame.new(- 16549.890625, 55.68635559082031, -
179.91360473632812)
CFrameMon = CFrame.new(- 16912.130859375,
11.787443161010742, - 133.0850830078125)
elseif L_120_ >= 2525 or SelectMonster == "Isle Champion" or
SelectArea == 'Tiki Outpost' then
Ms = "Isle Champion"
NameQuest = "TikiQuest2"
QuestLv = 2
NameMon = "Isle Champion"
CFrameQ = CFrame.new(- 16542.447265625,
55.68632888793945, 1044.41650390625)
CFrameMon = CFrame.new(- 16848.94140625,
21.68633460998535, 1041.4490966796875)
end
end
end
--// Select Monster
...
QuestLvBoss = 3
RewardBoss = "Reward:\n$2,000\n7,000 Exp."
CFrameQBoss = CFrame.new(- 1601.6553955078,
36.85213470459, 153.38809204102)
CFrameBoss = CFrame.new(- 1088.75977, 8.13463783, -
488.559906, - 0.707134247, 0, 0.707079291, 0, 1, 0, - 0.707079291, 0, - 0.707134247)
...
QuestLvBoss = 3
RewardBoss = "Reward:\n$8,000\n35,000 Exp."
CFrameQBoss = CFrame.new(- 1140.1761474609,
4.752049446106, 3827.4057617188)
CFrameBoss = CFrame.new(- 1087.3760986328,
46.949409484863, 4040.1462402344)
elseif SelectBoss == "The Saw" then
BossMon = "The Saw"
NameBoss = 'The Saw'
CFrameBoss = CFrame.new(- 784.89715576172,
72.427383422852, 1603.5822753906)
...
QuestLvBoss = 3
RewardBoss = "Reward:\n$10,000\n180,000 Exp."
CFrameQBoss = CFrame.new(1386.8073730469,
87.272789001465, - 1298.3576660156)
CFrameBoss = CFrame.new(1218.7956542969,
138.01184082031, - 1488.0262451172)
elseif SelectBoss == "Mob Leader" then
BossMon = "Mob Leader"
NameBoss = 'Mob Leader'
CFrameBoss = CFrame.new(- 2844.7307128906,
...
QuestLvBoss = 2
RewardBoss = "Reward:\n$10,000\n180,000 Exp."
CFrameQBoss = CFrame.new(- 5036.2465820313,
28.677835464478, 4324.56640625)
CFrameBoss = CFrame.new(- 5006.5454101563,
88.032081604004, 4353.162109375)
elseif SelectBoss == "Saber Expert" then
NameBoss = 'Saber Expert'
BossMon = "Saber Expert"
CFrameBoss = CFrame.new(- 1458.89502, 29.8870335, -
50.633564)
...
QuestLvBoss = 1
RewardBoss = "Reward:\n$6,000\n850,000 Exp."
CFrameBoss = CFrame.new(5278.04932, 2.15167475,
944.101929, 0.220546961, - 4.49946401e-06, 0.975376427, - 1.95412576e-05, 1,
9.03162072e-06, - 0.975376427, - 2.10519756e-05, 0.220546961)
CFrameQBoss = CFrame.new(5191.86133, 2.84020686,
686.438721, - 0.731384635, 0, 0.681965172, 0, 1, 0, - 0.681965172, 0, - 0.731384635)
...
QuestLvBoss = 2
RewardBoss = "Reward:\n$10,000\n1,000,000 Exp."
CFrameBoss = CFrame.new(5206.92578, 0.997753382,
814.976746, 0.342041343, - 0.00062915677, 0.939684749, 0.00191645394, 0.999998152, -
...
QuestLvBoss = 3
RewardBoss = "Reward:\n$15,000\n1,600,000 Exp."
CFrameBoss = CFrame.new(5325.09619, 7.03906584,
719.570679, - 0.309060812, 0, 0.951042235, 0, 1, 0, - 0.951042235, 0, - 0.309060812)
CFrameQBoss = CFrame.new(5191.86133, 2.84020686,
686.438721, - 0.731384635, 0, 0.681965172, 0, 1, 0, - 0.681965172, 0, - 0.731384635)
...
QuestLvBoss = 3
RewardBoss = "Reward:\n$15,000\n2,800,000 Exp."
CFrameQBoss = CFrame.new(- 5314.6220703125,
12.262420654297, 8517.279296875)
CFrameBoss = CFrame.new(- 5765.8969726563,
82.92064666748, 8718.3046875)
...
QuestLvBoss = 3
RewardBoss = "Reward:\n$15,000\n4,000,000 Exp."
CFrameQBoss = CFrame.new(61122.65234375,
18.497442245483, 1569.3997802734)
...
QuestLvBoss = 3
RewardBoss = "Reward:\n$15,000\n4,800,000 Exp."
CFrameQBoss = CFrame.new(- 7861.947265625,
5545.517578125, - 379.85974121094)
CFrameBoss = CFrame.new(- 7866.1333007813,
5576.4311523438, - 546.74816894531)
...
QuestLvBoss = 3
RewardBoss = "Reward:\n$20,000\n5,800,000 Exp."
CFrameQBoss = CFrame.new(- 7903.3828125,
5635.9897460938, - 1410.923828125)
...
QuestLvBoss = 3
RewardBoss = "Reward:\n$20,000\n7,500,000 Exp."
CFrameQBoss = CFrame.new(5258.2788085938,
38.526931762695, 4050.044921875)
CFrameBoss = CFrame.new(6094.0249023438,
73.770050048828, 3825.7348632813)
elseif SelectBoss == "Ice Admiral" then
BossMon = "Ice Admiral"
NameBoss = 'Ice Admiral'
CFrameBoss = CFrame.new(1266.08948, 26.1757946, -
1399.57678, - 0.573599219, 0, - 0.81913656, 0, 1, 0, 0.81913656, 0, - 0.573599219)
elseif SelectBoss == "Greybeard" then
BossMon = "Greybeard"
NameBoss = 'Greybeard'
CFrameBoss = CFrame.new(- 5081.3452148438,
85.221641540527, 4257.3588867188)
end
end
if Second_Sea then
...
QuestLvBoss = 3
RewardBoss = "Reward:\n$25,000\n9,000,000 Exp."
CFrameQBoss = CFrame.new(- 427.5666809082,
73.313781738281, 1835.4208984375)
CFrameBoss = CFrame.new(- 1576.7166748047,
198.59265136719, 13.724286079407)
...
QuestLvBoss = 3
RewardBoss = "Reward:\n$25,000\n11,500,000 Exp."
CFrameQBoss = CFrame.new(636.79943847656,
73.413787841797, 918.00415039063)
CFrameBoss = CFrame.new(2006.9261474609,
448.95666503906, 853.98284912109)
...
QuestLvBoss = 3
RewardBoss = "Reward:\n$25,000\n15,000,000 Exp."
CFrameQBoss = CFrame.new(- 2441.986328125,
73.359344482422, - 3217.5324707031)
CFrameBoss = CFrame.new(- 2172.7399902344,
103.32216644287, - 4015.025390625)
elseif SelectBoss == "Don Swan" then
BossMon = "Don Swan"
NameBoss = 'Don Swan'
CFrameBoss = CFrame.new(2286.2004394531,
15.177839279175, 863.8388671875)
...
QuestLvBoss = 3
RewardBoss = "Reward:\n$20,000\n25,000,000 Exp."
CFrameQBoss = CFrame.new(- 5429.0473632813,
15.977565765381, - 5297.9614257813)
CFrameBoss = CFrame.new(- 5275.1987304688,
20.757257461548, - 5260.6669921875)
...
QuestLvBoss = 3
RewardBoss = "Reward:\n$20,000\n36,000,000 Exp."
CFrameQBoss = CFrame.new(5668.9780273438,
28.519989013672, - 6483.3520507813)
CFrameBoss = CFrame.new(6403.5439453125,
340.29766845703, - 6894.5595703125)
...
QuestLvBoss = 3
RewardBoss = "Reward:\n$12,500\n38,000,000 Exp."
CFrameQBoss = CFrame.new(- 3053.9814453125,
237.18954467773, - 10145.0390625)
CFrameBoss = CFrame.new(- 3795.6423339844,
105.88877105713, - 11421.307617188)
...
BossMon = "Order"
NameBoss = 'Order'
CFrameBoss = CFrame.new(- 6217.2021484375,
...
QuestLvBoss = 3
RewardBoss = "Reward:\n$25,000\n40,000,000 Exp."
CFrameQBoss = CFrame.new(- 289.76705932617,
43.819011688232, 5579.9384765625)
CFrameBoss = CFrame.new(- 1027.6512451172,
92.404174804688, 6578.8530273438)
...
QuestLvBoss = 3
RewardBoss = "Reward:\n$30,000\n52,000,000 Exp."
CFrameQBoss = CFrame.new(5445.9541015625,
601.62945556641, 751.43792724609)
...
QuestLvBoss = 3
RewardBoss = "Reward:\n$35,000\n56,000,000 Exp."
CFrameQBoss = CFrame.new(2179.3010253906,
28.731239318848, - 6739.9741210938)
CFrameBoss = CFrame.new(2764.2233886719,
432.46154785156, - 7144.4580078125)
...
QuestLvBoss = 3
RewardBoss = "Reward:\n$40,000\n67,000,000 Exp."
CFrameQBoss = CFrame.new(- 13232.682617188,
332.40396118164, - 7626.01171875)
CFrameBoss = CFrame.new(- 13376.7578125,
433.28689575195, - 8071.392578125)
...
QuestLvBoss = 3
RewardBoss = "Reward:\n$50,000\n70,000,000 Exp."
CFrameQBoss = CFrame.new(- 12682.096679688,
390.88653564453, - 9902.1240234375)
...
QuestLvBoss = 3
RewardBoss = "Reward:\n$30,000\n112,500,000 Exp."
CFrameQBoss = CFrame.new(- 819.376709, 64.9259796, -
10967.2832, - 0.766061664, 0, 0.642767608, 0, 1, 0, - 0.642767608, 0, - 0.766061664)
CFrameBoss = CFrame.new(- 678.648804, 381.353943, -
11114.2012, - 0.908641815, 0.00149294338, 0.41757378, 0.00837114919, 0.999857843,
0.0146408929, - 0.417492568, 0.0167988986, - 0.90852499)
elseif SelectBoss == "Longma" then
BossMon = "Longma"
NameBoss = 'Longma'
CFrameBoss = CFrame.new(- 10238.875976563,
...
CFrameBoss = CFrame.new(- 5415.3920898438,
505.74133300781, - 2814.0166015625)
end
end
end
--// Check Material
...
elseif Second_Sea then
MMon = "Marine Captain"
MPos = CFrame.new(- 2010.5059814453125,
...
MPos = CFrame.new(620.6344604492188, 78.93644714355469, -
12581.369140625)
SP = "Default"
...
for L_121_forvar0, L_122_forvar1 in
pairs(game:GetService("Workspace")["_WorldOrigin"].Locations:GetChildren()) do
pcall(function()
if IslandESP then
if L_122_forvar1.Name ~= "Sea" then
if not L_122_forvar1:FindFirstChild('NameEsp')
then
local L_123_ = Instance.new('BillboardGui',
L_122_forvar1)
L_123_.Name = 'NameEsp'
L_123_.ExtentsOffset = Vector3.new(0, 1,
0)
...
L_124_.TextColor3 = Color3.fromRGB(8, 0,
0)
else
L_122_forvar1['NameEsp'].TextLabel.Text =
(L_122_forvar1.Name .. ' \n' ..
round((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_122_forvar1.Position).Magnitude / 3) .. ' Distance')
end
end
else
...
for L_127_forvar0, L_128_forvar1 in
pairs(game:GetService'Players':GetChildren()) do
pcall(function()
if not isnil(L_128_forvar1.Character) then
if ESPPlayer then
if not isnil(L_128_forvar1.Character.Head) and not
L_128_forvar1.Character.Head:FindFirstChild('NameEsp' .. Number) then
local L_129_ = Instance.new('BillboardGui',
L_128_forvar1.Character.Head)
L_129_.Name = 'NameEsp' .. Number
L_129_.ExtentsOffset = Vector3.new(0, 1,
0)
L_129_.Size = UDim2.new(1, 200, 1, 30)
L_129_.Adornee =
L_128_forvar1.Character.Head
L_129_.AlwaysOnTop = true
local L_130_ = Instance.new('TextLabel',
L_129_)
L_130_.Font =
...
.. L_84_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_128_forvar1.Character.Head.Position).Magnitude / 3) .. ' Distance')
L_130_.Size = UDim2.new(1, 0, 1, 0)
L_130_.TextYAlignment = 'Top'
L_130_.BackgroundTransparency = 1
L_130_.TextStrokeTransparency = 0.5
if L_128_forvar1.Team ==
game.Players.LocalPlayer.Team then
L_130_.TextColor3 = Color3.new(0,
0, 254)
else
L_130_.TextColor3 =
Color3.new(255, 0, 0)
...
L_128_forvar1.Character.Head['NameEsp' ..
Number].TextLabel.Text = (L_128_forvar1.Name .. ' | ' ..
L_84_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_128_forvar1.Character.Head.Position).Magnitude / 3) .. ' Distance\nHealth : ' ..
L_84_func(L_128_forvar1.Character.Humanoid.Health * 100 /
L_128_forvar1.Character.Humanoid.MaxHealth) .. '%')
end
else
if
L_128_forvar1.Character.Head:FindFirstChild('NameEsp' .. Number) then
...
if string.find(L_132_forvar1.Name, "Chest") then
if not
L_132_forvar1:FindFirstChild('NameEsp' .. Number) then
local L_133_ =
Instance.new('BillboardGui', L_132_forvar1)
L_133_.Name = 'NameEsp' ..
Number
L_133_.ExtentsOffset =
Vector3.new(0, 1, 0)
L_133_.Size = UDim2.new(1, 200, 1,
30)
L_133_.Adornee = L_132_forvar1
L_133_.AlwaysOnTop = true
local L_134_ =
Instance.new('TextLabel', L_133_)
L_134_.Font =
Enum.Font.GothamSemibold
L_134_.FontSize = "Size14"
L_134_.TextWrapped = true
L_134_.Size = UDim2.new(1, 0, 1,
0)
L_134_.TextYAlignment = 'Top'
L_134_.BackgroundTransparency =
1
L_134_.TextStrokeTransparency =
0.5
if L_132_forvar1.Name == "Chest1"
then
L_134_.TextColor3 =
Color3.fromRGB(109, 109, 109)
L_134_.Text = ("Chest 1" .. '
\n' .. L_84_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_132_forvar1.Position).Magnitude / 3) .. ' Distance')
end
if L_132_forvar1.Name == "Chest2"
then
L_134_.TextColor3 =
...
L_132_forvar1['NameEsp' ..
Number].TextLabel.Text = (L_132_forvar1.Name .. ' \n' ..
L_84_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_132_forvar1.Position).Magnitude / 3) .. ' Distance')
end
end
else
if L_132_forvar1:FindFirstChild('NameEsp' ..
Number) then
L_132_forvar1:FindFirstChild('NameEsp' ..
Number):Destroy()
end
end
end
...
if not
L_136_forvar1.Handle:FindFirstChild('NameEsp' .. Number) then
local L_137_ = Instance.new('BillboardGui',
L_136_forvar1.Handle)
L_137_.Name = 'NameEsp' .. Number
L_137_.ExtentsOffset = Vector3.new(0, 1,
0)
L_137_.Size = UDim2.new(1, 200, 1, 30)
L_137_.Adornee = L_136_forvar1.Handle
L_137_.AlwaysOnTop = true
local L_138_ = Instance.new('TextLabel',
L_137_)
L_138_.Font =
Enum.Font.GothamSemibold
...
L_138_.TextColor3 = Color3.fromRGB(255,
255, 255)
L_138_.Text = (L_136_forvar1.Name .. ' \n'
.. L_84_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_136_forvar1.Handle.Position).Magnitude / 3) .. ' Distance')
else
L_136_forvar1.Handle['NameEsp' ..
Number].TextLabel.Text = (L_136_forvar1.Name .. ' \n' ..
L_84_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_136_forvar1.Handle.Position).Magnitude / 3) .. ' Distance')
end
end
else
if L_136_forvar1.Handle:FindFirstChild('NameEsp' ..
Number) then
L_136_forvar1.Handle:FindFirstChild('NameEsp' ..
Number):Destroy()
end
end
end)
...
pcall(function()
if L_140_forvar1.Name == "Flower2" or L_140_forvar1.Name ==
"Flower1" then
if FlowerESP then
if not L_140_forvar1:FindFirstChild('NameEsp' ..
Number) then
local L_141_ = Instance.new('BillboardGui',
L_140_forvar1)
L_141_.Name = 'NameEsp' .. Number
L_141_.ExtentsOffset = Vector3.new(0, 1,
0)
L_141_.Size = UDim2.new(1, 200, 1, 30)
L_141_.Adornee = L_140_forvar1
L_141_.AlwaysOnTop = true
local L_142_ = Instance.new('TextLabel',
L_141_)
L_142_.Font =
Enum.Font.GothamSemibold
...
L_142_.TextColor3 = Color3.fromRGB(255,
0, 0)
if L_140_forvar1.Name == "Flower1" then
L_142_.Text = ("Blue Flower" .. ' \n' ..
L_84_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_140_forvar1.Position).Magnitude / 3) .. ' Distance')
L_142_.TextColor3 =
...
L_140_forvar1['NameEsp' ..
Number].TextLabel.Text = (L_140_forvar1.Name .. ' \n' ..
L_84_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_140_forvar1.Position).Magnitude / 3) .. ' Distance')
end
else
if L_140_forvar1:FindFirstChild('NameEsp' ..
Number) then
L_140_forvar1:FindFirstChild('NameEsp' ..
Number):Destroy()
end
end
end
...
for L_143_forvar0, L_144_forvar1 in
pairs(game.Workspace.AppleSpawner:GetChildren()) do
if L_144_forvar1:IsA("Tool") then
if RealFruitESP then
if not L_144_forvar1.Handle:FindFirstChild('NameEsp' ..
Number) then
local L_145_ = Instance.new('BillboardGui',
L_144_forvar1.Handle)
...
L_84_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_144_forvar1.Handle.Position).Magnitude / 3) .. ' Distance')
else
L_144_forvar1.Handle['NameEsp' ..
Number].TextLabel.Text = (L_144_forvar1.Name .. ' ' ..
L_84_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_144_forvar1.Handle.Position).Magnitude / 3) .. ' Distance')
end
else
if L_144_forvar1.Handle:FindFirstChild('NameEsp' ..
Number) then
L_144_forvar1.Handle:FindFirstChild('NameEsp' ..
Number):Destroy()
end
end
end
end
for L_147_forvar0, L_148_forvar1 in
pairs(game.Workspace.PineappleSpawner:GetChildren()) do
if L_148_forvar1:IsA("Tool") then
if RealFruitESP then
if not L_148_forvar1.Handle:FindFirstChild('NameEsp' ..
Number) then
local L_149_ = Instance.new('BillboardGui',
L_148_forvar1.Handle)
...
L_84_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_148_forvar1.Handle.Position).Magnitude / 3) .. ' Distance')
else
L_148_forvar1.Handle['NameEsp' ..
Number].TextLabel.Text = (L_148_forvar1.Name .. ' ' ..
L_84_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_148_forvar1.Handle.Position).Magnitude / 3) .. ' Distance')
end
else
if L_148_forvar1.Handle:FindFirstChild('NameEsp' ..
Number) then
L_148_forvar1.Handle:FindFirstChild('NameEsp' ..
Number):Destroy()
end
end
end
end
for L_151_forvar0, L_152_forvar1 in
pairs(game.Workspace.BananaSpawner:GetChildren()) do
if L_152_forvar1:IsA("Tool") then
if RealFruitESP then
if not L_152_forvar1.Handle:FindFirstChild('NameEsp' ..
Number) then
local L_153_ = Instance.new('BillboardGui',
L_152_forvar1.Handle)
...
L_84_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_152_forvar1.Handle.Position).Magnitude / 3) .. ' Distance')
else
L_152_forvar1.Handle['NameEsp' ..
Number].TextLabel.Text = (L_152_forvar1.Name .. ' ' ..
L_84_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_152_forvar1.Handle.Position).Magnitude / 3) .. ' Distance')
end
else
if L_152_forvar1.Handle:FindFirstChild('NameEsp' ..
Number) then
L_152_forvar1.Handle:FindFirstChild('NameEsp' ..
Number):Destroy()
end
end
end
...
if not L_156_forvar1:FindFirstChild('NameEsp')
then
local L_157_ = Instance.new('BillboardGui',
L_156_forvar1)
L_157_.Name = 'NameEsp'
L_157_.ExtentsOffset = Vector3.new(0, 1,
0)
L_157_.Size = UDim2.new(1, 200, 1, 30)
L_157_.Adornee = L_156_forvar1
L_157_.AlwaysOnTop = true
local L_158_ = Instance.new('TextLabel',
L_157_)
...
L_158_.TextColor3 = Color3.fromRGB(7,
236, 240)
else
L_156_forvar1['NameEsp'].TextLabel.Text =
(L_156_forvar1.Name .. ' \n' ..
L_84_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_156_forvar1.Position).Magnitude / 3) .. ' Distance')
end
end
else
...
Number = math.random(1, 1000000)
function UpdatePlayerChams()
for L_161_forvar0, L_162_forvar1 in
pairs(game:GetService'Players':GetChildren()) do
pcall(function()
if not isnil(L_162_forvar1.Character) then
if ESPPlayer then
if not isnil(L_162_forvar1.Character.Head) and not
L_162_forvar1.Character.Head:FindFirstChild('NameEsp' .. Number) then
local L_163_ = Instance.new('BillboardGui',
L_162_forvar1.Character.Head)
L_163_.Name = 'NameEsp' .. Number
L_163_.ExtentsOffset = Vector3.new(0, 1,
0)
L_163_.Size = UDim2.new(1, 200, 1, 30)
L_163_.Adornee =
L_162_forvar1.Character.Head
L_163_.AlwaysOnTop = true
local L_164_ = Instance.new('TextLabel',
L_163_)
L_164_.Font =
Enum.Font.GothamSemibold
...
.. L_85_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_162_forvar1.Character.Head.Position).Magnitude / 3) .. ' Distance')
L_164_.Size = UDim2.new(1, 0, 1, 0)
L_164_.TextYAlignment = 'Top'
L_164_.BackgroundTransparency = 1
L_164_.TextStrokeTransparency = 0.5
if L_162_forvar1.Team ==
game.Players.LocalPlayer.Team then
L_164_.TextColor3 = Color3.new(0,
255, 0)
else
L_164_.TextColor3 =
Color3.new(255, 0, 0)
...
L_162_forvar1.Character.Head['NameEsp' ..
Number].TextLabel.Text = (L_162_forvar1.Name .. ' | ' ..
L_85_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_162_forvar1.Character.Head.Position).Magnitude / 3) .. ' Distance\nHealth : ' ..
L_85_func(L_162_forvar1.Character.Humanoid.Health * 100 /
L_162_forvar1.Character.Humanoid.MaxHealth) .. '%')
end
else
if
L_162_forvar1.Character.Head:FindFirstChild('NameEsp' .. Number) then
...
if string.find(L_166_forvar1.Name, "Chest") then
if not
L_166_forvar1:FindFirstChild('NameEsp' .. Number) then
local L_167_ =
Instance.new('BillboardGui', L_166_forvar1)
L_167_.Name = 'NameEsp' ..
Number
L_167_.ExtentsOffset =
Vector3.new(0, 1, 0)
L_167_.Size = UDim2.new(1, 200, 1,
30)
L_167_.Adornee = L_166_forvar1
L_167_.AlwaysOnTop = true
local L_168_ =
Instance.new('TextLabel', L_167_)
L_168_.Font =
Enum.Font.GothamSemibold
L_168_.FontSize = "Size14"
L_168_.TextWrapped = true
L_168_.Size = UDim2.new(1, 0, 1,
0)
L_168_.TextYAlignment = 'Top'
L_168_.BackgroundTransparency =
1
L_168_.TextStrokeTransparency =
0.5
if L_166_forvar1.Name == "Chest1"
then
L_168_.TextColor3 =
Color3.fromRGB(109, 109, 109)
L_168_.Text = ("Chest 1" .. '
\n' .. L_85_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_166_forvar1.Position).Magnitude / 3) .. ' Distance')
end
if L_166_forvar1.Name == "Chest2"
then
L_168_.TextColor3 =
Color3.fromRGB(173, 158, 21)
L_168_.Text = ("Chest 2" .. '
...
L_166_forvar1['NameEsp' ..
Number].TextLabel.Text = (L_166_forvar1.Name .. ' \n' ..
L_85_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_166_forvar1.Position).Magnitude / 3) .. ' Distance')
end
end
else
if L_166_forvar1:FindFirstChild('NameEsp' ..
Number) then
L_166_forvar1:FindFirstChild('NameEsp' ..
Number):Destroy()
end
end
end
...
if not
L_170_forvar1.Handle:FindFirstChild('NameEsp' .. Number) then
local L_171_ = Instance.new('BillboardGui',
L_170_forvar1.Handle)
L_171_.Name = 'NameEsp' .. Number
L_171_.ExtentsOffset = Vector3.new(0, 1,
0)
L_171_.Size = UDim2.new(1, 200, 1, 30)
L_171_.Adornee = L_170_forvar1.Handle
L_171_.AlwaysOnTop = true
local L_172_ = Instance.new('TextLabel',
L_171_)
L_172_.Font =
Enum.Font.GothamSemibold
...
L_172_.TextColor3 = Color3.fromRGB(255,
255, 255)
L_172_.Text = (L_170_forvar1.Name .. ' \n'
.. L_85_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_170_forvar1.Handle.Position).Magnitude / 3) .. ' Distance')
else
L_170_forvar1.Handle['NameEsp' ..
Number].TextLabel.Text = (L_170_forvar1.Name .. ' \n' ..
L_85_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_170_forvar1.Handle.Position).Magnitude / 3) .. ' Distance')
end
end
else
if L_170_forvar1.Handle:FindFirstChild('NameEsp' ..
Number) then
L_170_forvar1.Handle:FindFirstChild('NameEsp' ..
Number):Destroy()
end
end
end)
...
pcall(function()
if L_174_forvar1.Name == "Flower2" or L_174_forvar1.Name ==
"Flower1" then
if FlowerESP then
if not L_174_forvar1:FindFirstChild('NameEsp' ..
Number) then
local L_175_ = Instance.new('BillboardGui',
L_174_forvar1)
L_175_.Name = 'NameEsp' .. Number
L_175_.ExtentsOffset = Vector3.new(0, 1,
0)
L_175_.Size = UDim2.new(1, 200, 1, 30)
L_175_.Adornee = L_174_forvar1
L_175_.AlwaysOnTop = true
local L_176_ = Instance.new('TextLabel',
L_175_)
L_176_.Font =
Enum.Font.GothamSemibold
...
L_176_.TextColor3 = Color3.fromRGB(255,
0, 0)
if L_174_forvar1.Name == "Flower1" then
L_176_.Text = ("Blue Flower" .. ' \n' ..
L_85_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_174_forvar1.Position).Magnitude / 3) .. ' Distance')
L_176_.TextColor3 =
Color3.fromRGB(0, 0, 255)
end
...
L_174_forvar1['NameEsp' ..
Number].TextLabel.Text = (L_174_forvar1.Name .. ' \n' ..
L_85_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_174_forvar1.Position).Magnitude / 3) .. ' Distance')
end
else
if L_174_forvar1:FindFirstChild('NameEsp' ..
Number) then
L_174_forvar1:FindFirstChild('NameEsp' ..
Number):Destroy()
end
end
end
...
function UpdateRealFruitChams()
for L_177_forvar0, L_178_forvar1 in
pairs(game.Workspace.AppleSpawner:GetChildren()) do
if L_178_forvar1:IsA("Tool") then
if RealFruitESP then
if not L_178_forvar1.Handle:FindFirstChild('NameEsp' ..
Number) then
local L_179_ = Instance.new('BillboardGui',
L_178_forvar1.Handle)
...
L_85_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_178_forvar1.Handle.Position).Magnitude / 3) .. ' Distance')
else
L_178_forvar1.Handle['NameEsp' ..
Number].TextLabel.Text = (L_178_forvar1.Name .. ' ' ..
L_85_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_178_forvar1.Handle.Position).Magnitude / 3) .. ' Distance')
end
else
if L_178_forvar1.Handle:FindFirstChild('NameEsp' ..
Number) then
L_178_forvar1.Handle:FindFirstChild('NameEsp' ..
Number):Destroy()
end
end
end
end
for L_181_forvar0, L_182_forvar1 in
pairs(game.Workspace.PineappleSpawner:GetChildren()) do
if L_182_forvar1:IsA("Tool") then
if RealFruitESP then
if not L_182_forvar1.Handle:FindFirstChild('NameEsp' ..
Number) then
local L_183_ = Instance.new('BillboardGui',
L_182_forvar1.Handle)
...
L_85_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_182_forvar1.Handle.Position).Magnitude / 3) .. ' Distance')
else
L_182_forvar1.Handle['NameEsp' ..
Number].TextLabel.Text = (L_182_forvar1.Name .. ' ' ..
L_85_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_182_forvar1.Handle.Position).Magnitude / 3) .. ' Distance')
end
else
if L_182_forvar1.Handle:FindFirstChild('NameEsp' ..
Number) then
L_182_forvar1.Handle:FindFirstChild('NameEsp' ..
Number):Destroy()
end
end
end
end
for L_185_forvar0, L_186_forvar1 in
pairs(game.Workspace.BananaSpawner:GetChildren()) do
if L_186_forvar1:IsA("Tool") then
if RealFruitESP then
if not L_186_forvar1.Handle:FindFirstChild('NameEsp' ..
Number) then
local L_187_ = Instance.new('BillboardGui',
L_186_forvar1.Handle)
...
L_85_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_186_forvar1.Handle.Position).Magnitude / 3) .. ' Distance')
else
L_186_forvar1.Handle['NameEsp' ..
Number].TextLabel.Text = (L_186_forvar1.Name .. ' ' ..
L_85_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_186_forvar1.Handle.Position).Magnitude / 3) .. ' Distance')
end
else
if L_186_forvar1.Handle:FindFirstChild('NameEsp' ..
Number) then
L_186_forvar1.Handle:FindFirstChild('NameEsp' ..
Number):Destroy()
end
end
end
...
pcall(function()
if MobESP then
for L_189_forvar0, L_190_forvar1 in
pairs(game:GetService("Workspace").Enemies:GetChildren()) do
if
L_190_forvar1:FindFirstChild('HumanoidRootPart') then
if not
L_190_forvar1:FindFirstChild("MobEap") then
local L_192_ =
Instance.new("BillboardGui")
local L_193_ =
Instance.new("TextLabel")
L_192_.Parent = L_190_forvar1
L_192_.ZIndexBehavior =
Enum.ZIndexBehavior.Sibling
L_192_.Active = true
L_192_.Name = "MobEap"
L_192_.AlwaysOnTop = true
L_192_.LightInfluence = 1.000
L_192_.Size = UDim2.new(0, 200, 0,
50)
L_192_.StudsOffset =
Vector3.new(0, 2.5, 0)
L_193_.Parent = L_192_
L_193_.BackgroundColor3 =
Color3.fromRGB(255, 255, 255)
L_193_.BackgroundTransparency =
1.000
L_193_.Size = UDim2.new(0, 200, 0,
50)
L_193_.Font =
Enum.Font.GothamBold
L_193_.TextColor3 =
Color3.fromRGB(7, 236, 240)
L_193_.Text.Size = 35
end
local L_191_ =
math.floor((game.Players.LocalPlayer.Character.HumanoidRootPart.Position -
L_190_forvar1.HumanoidRootPart.Position).Magnitude)
L_190_forvar1.MobEap.TextLabel.Text =
L_190_forvar1.Name .. " - " .. L_191_ .. " Distance"
end
end
else
for L_194_forvar0, L_195_forvar1 in
pairs(game:GetService("Workspace").Enemies:GetChildren()) do
...
pcall(function()
if SeaESP then
for L_196_forvar0, L_197_forvar1 in
pairs(game:GetService("Workspace").SeaBeasts:GetChildren()) do
if
L_197_forvar1:FindFirstChild('HumanoidRootPart') then
if not
L_197_forvar1:FindFirstChild("Seaesps") then
local L_199_ =
Instance.new("BillboardGui")
local L_200_ =
Instance.new("TextLabel")
L_199_.Parent = L_197_forvar1
L_199_.ZIndexBehavior =
Enum.ZIndexBehavior.Sibling
L_199_.Active = true
L_199_.Name = "Seaesps"
L_199_.AlwaysOnTop = true
L_199_.LightInfluence = 1.000
L_199_.Size = UDim2.new(0, 200, 0,
50)
L_199_.StudsOffset =
Vector3.new(0, 2.5, 0)
L_200_.Parent = L_199_
L_200_.BackgroundColor3 =
Color3.fromRGB(255, 255, 255)
L_200_.BackgroundTransparency =
1.000
L_200_.Size = UDim2.new(0, 200, 0,
50)
L_200_.Font =
Enum.Font.GothamBold
L_200_.TextColor3 =
...
local L_198_ =
math.floor((game.Players.LocalPlayer.Character.HumanoidRootPart.Position -
L_197_forvar1.HumanoidRootPart.Position).Magnitude)
L_197_forvar1.Seaesps.TextLabel.Text =
L_197_forvar1.Name .. " - " .. L_198_ .. " Distance"
end
end
else
for L_201_forvar0, L_202_forvar1 in
pairs(game:GetService("Workspace").SeaBeasts:GetChildren()) do
...
pcall(function()
if NpcESP then
for L_203_forvar0, L_204_forvar1 in
pairs(game:GetService("Workspace").NPCs:GetChildren()) do
if
L_204_forvar1:FindFirstChild('HumanoidRootPart') then
if not
L_204_forvar1:FindFirstChild("NpcEspes") then
local L_206_ =
Instance.new("BillboardGui")
local L_207_ =
Instance.new("TextLabel")
L_206_.Parent = L_204_forvar1
L_206_.ZIndexBehavior =
Enum.ZIndexBehavior.Sibling
L_206_.Active = true
L_206_.Name = "NpcEspes"
L_206_.AlwaysOnTop = true
L_206_.LightInfluence = 1.000
L_206_.Size = UDim2.new(0, 200, 0,
50)
L_206_.StudsOffset =
Vector3.new(0, 2.5, 0)
L_207_.Parent = L_206_
L_207_.BackgroundColor3 =
Color3.fromRGB(255, 255, 255)
L_207_.BackgroundTransparency =
1.000
L_207_.Size = UDim2.new(0, 200, 0,
50)
L_207_.Font =
Enum.Font.GothamBold
L_207_.TextColor3 =
...
local L_205_ =
math.floor((game.Players.LocalPlayer.Character.HumanoidRootPart.Position -
L_204_forvar1.HumanoidRootPart.Position).Magnitude)
L_204_forvar1.NpcEspes.TextLabel.Text =
L_204_forvar1.Name .. " - " .. L_205_ .. " Distance"
end
end
else
for L_208_forvar0, L_209_forvar1 in
pairs(game:GetService("Workspace").NPCs:GetChildren()) do
...
for L_212_forvar0, L_213_forvar1 in
pairs(game:GetService("Workspace")["_WorldOrigin"].Locations:GetChildren()) do
pcall(function()
if MirageIslandESP then
if L_213_forvar1.Name == "Mirage Island" then
if not L_213_forvar1:FindFirstChild('NameEsp')
then
local L_214_ = Instance.new('BillboardGui',
L_213_forvar1)
L_214_.Name = 'NameEsp'
L_214_.ExtentsOffset = Vector3.new(0, 1,
0)
L_214_.Size = UDim2.new(1, 200, 1, 30)
L_214_.Adornee = L_213_forvar1
L_214_.AlwaysOnTop = true
local L_215_ = Instance.new('TextLabel',
L_214_)
L_215_.Font = "Code"
...
L_215_.TextColor3 = Color3.fromRGB(80,
245, 245)
else
L_213_forvar1['NameEsp'].TextLabel.Text =
(L_213_forvar1.Name .. ' \n' ..
L_86_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_213_forvar1.Position).Magnitude / 3) .. ' M')
end
end
else
...
for L_218_forvar0, L_219_forvar1 in
pairs(game:GetService("Workspace").NPCs:GetChildren()) do
pcall(function()
if AfdESP then
if L_219_forvar1.Name == "Advanced Fruit Dealer" then
if not L_219_forvar1:FindFirstChild('NameEsp')
then
local L_220_ = Instance.new('BillboardGui',
L_219_forvar1)
L_220_.Name = 'NameEsp'
L_220_.ExtentsOffset = Vector3.new(0, 1,
0)
L_220_.Size = UDim2.new(1, 200, 1, 30)
L_220_.Adornee = L_219_forvar1
L_220_.AlwaysOnTop = true
local L_221_ = Instance.new('TextLabel',
L_220_)
L_221_.Font = "Code"
...
L_221_.TextColor3 = Color3.fromRGB(80,
245, 245)
else
L_219_forvar1['NameEsp'].TextLabel.Text =
(L_219_forvar1.Name .. ' \n' ..
L_87_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_219_forvar1.Position).Magnitude / 3) .. ' M')
end
end
else
...
for L_222_forvar0, L_223_forvar1 in
pairs(game:GetService("Workspace").NPCs:GetChildren()) do
pcall(function()
if AuraESP then
if L_223_forvar1.Name == "Master of Enhancement" then
if not L_223_forvar1:FindFirstChild('NameEsp')
then
local L_224_ = Instance.new('BillboardGui',
L_223_forvar1)
L_224_.Name = 'NameEsp'
L_224_.ExtentsOffset = Vector3.new(0, 1,
0)
L_224_.Size = UDim2.new(1, 200, 1, 30)
L_224_.Adornee = L_223_forvar1
L_224_.AlwaysOnTop = true
local L_225_ = Instance.new('TextLabel',
L_224_)
L_225_.Font = "Code"
...
L_225_.TextColor3 = Color3.fromRGB(80,
245, 245)
else
L_223_forvar1['NameEsp'].TextLabel.Text =
(L_223_forvar1.Name .. ' \n' ..
L_87_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_223_forvar1.Position).Magnitude / 3) .. ' M')
end
end
else
...
for L_226_forvar0, L_227_forvar1 in
pairs(game:GetService("Workspace").NPCs:GetChildren()) do
pcall(function()
if LADESP then
if L_227_forvar1.Name == "Legendary Sword Dealer" then
if not L_227_forvar1:FindFirstChild('NameEsp')
then
local L_228_ = Instance.new('BillboardGui',
L_227_forvar1)
L_228_.Name = 'NameEsp'
L_228_.ExtentsOffset = Vector3.new(0, 1,
0)
L_228_.Size = UDim2.new(1, 200, 1, 30)
L_228_.Adornee = L_227_forvar1
L_228_.AlwaysOnTop = true
local L_229_ = Instance.new('TextLabel',
L_228_)
L_229_.Font = "Code"
...
L_229_.TextColor3 = Color3.fromRGB(80,
245, 245)
else
L_227_forvar1['NameEsp'].TextLabel.Text =
(L_227_forvar1.Name .. ' \n' ..
L_87_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_227_forvar1.Position).Magnitude / 3) .. ' M')
end
end
else
...
for L_230_forvar0, L_231_forvar1 in
pairs(game:GetService("Workspace").Map.MysticIsland:GetChildren()) do
pcall(function()
if GearESP then
if L_231_forvar1.Name == "MeshPart" then
if not L_231_forvar1:FindFirstChild('NameEsp')
then
local L_232_ = Instance.new('BillboardGui',
L_231_forvar1)
L_232_.Name = 'NameEsp'
L_232_.ExtentsOffset = Vector3.new(0, 1,
0)
L_232_.Size = UDim2.new(1, 200, 1, 30)
L_232_.Adornee = L_231_forvar1
L_232_.AlwaysOnTop = true
local L_233_ = Instance.new('TextLabel',
L_232_)
L_233_.Font = "Code"
...
L_233_.TextColor3 = Color3.fromRGB(80,
245, 245)
else
L_231_forvar1['NameEsp'].TextLabel.Text =
(L_231_forvar1.Name .. ' \n' ..
L_87_func((game:GetService('Players').LocalPlayer.Character.Head.Position -
L_231_forvar1.Position).Magnitude / 3) .. ' M')
end
end
else
...
local L_235_ = (L_234_arg0.Position -
game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude
if L_235_ >= 1 then
Speed = 300
end
game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRoot
Part, TweenInfo.new(L_235_ / Speed, Enum.EasingStyle.Linear), {
CFrame = L_234_arg0
}):Play()
...
for L_243_forvar0, L_244_forvar1 in
pairs(game.Workspace._WorldOrigin.PlayerSpawns:FindFirstChild(tostring(game.Players.Local
Player.Team)):GetChildren()) do
local L_245_ = (L_240_ -
L_244_forvar1:GetModelCFrame().p).Magnitude;
...
if BypassTP then
if L_250_ > 3000 and not AutoNextIsland and not
...
tostring(GetIsLand(L_248_)) then
wait(.1)
...
if
game:GetService("Players").LocalPlayer.Character:WaitForChild("Humanoid").Health > 0 then
...
local L_252_ = TweenInfo.new((L_248_.Position -
game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").Position
)
.Magnitude / Speed, Enum.EasingStyle.Linear)
local L_253_, L_254_ = pcall(function()
tween =
L_251_:Create(game.Players.LocalPlayer.Character["HumanoidRootPart"], L_252_, {
CFrame = L_248_
})
tween:Play()
end)
...
tween =
game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRoot
Part, TweenInfo.new(Distance / 300, Enum.EasingStyle.Linear), {
CFrame = L_255_arg0
})
end)
tween:Play()
...
L_256_arg0.Position).Magnitude <= 150 then
pcall(function()
tween:Cancel()
...
local L_258_ =
TweenInfo.new((game:GetService("Players")["LocalPlayer"].Character.HumanoidRootPart.Positi
on - L_256_arg0.Position).Magnitude / 325, Enum.EasingStyle.Linear)
tween =
L_257_:Create(game.Players.LocalPlayer.Character["HumanoidRootPart"], L_258_, {
CFrame = L_256_arg0
})
tween:Play()
local L_259_ = {}
...
local L_262_ =
TweenInfo.new((game:GetService("Workspace").Boats.MarineBrigade.VehicleSeat.CFrame.Pos
ition - L_260_arg0.Position).Magnitude / 300, Enum.EasingStyle.Linear)
tween =
L_261_:Create(game:GetService("Workspace").Boats.MarineBrigade.VehicleSeat, L_262_, {
CFrame = L_260_arg0
})
tween:Play()
local L_263_ = {}
...
local L_266_ =
TweenInfo.new((game:GetService("Players")["LocalPlayer"].Character.HumanoidRootPart.Positi
on - L_264_arg0.Position).Magnitude / 325, Enum.EasingStyle.Linear)
tween =
L_265_:Create(game.Players.LocalPlayer.Character["HumanoidRootPart"], L_266_, {
CFrame = L_264_arg0
})
tween:Play()
local L_267_ = {}
...
local L_269_ =
game.Players.LocalPlayer.Backpack:FindFirstChild(L_268_arg0)
wait(0.5)
...
if tostring(L_273_[2]) ~= "true" and tostring(L_273_[2]) ~=
"false" then
if _G.UseSkill then
...
L_273_[2] =
CFrame.new(PositionSkillMasteryDevilFruit)
end
...
while task.wait() do
pcall(function()
if _G.TeleportIsland or AutoFarmChest or _G.chestsea2 or
_G.chestsea3 or _G.CastleRaid or _G.CollectAzure or _G.TweenToKitsune or _G.AutoCandy or
_G.GhostShip or _G.Ship or _G.SailBoat or _G.Auto_Holy_Torch or _G.FindMirageIsland or
_G.TeleportPly or _G.Tweenfruit or _G.AutoFishCrew or _G.AutoShark or _G.AutoCakeV2 or
_G.AutoMysticIsland or _G.AutoQuestRace or _G.AutoBuyBoat or _G.dao or _G.AutoMirage or
AutoFarmAcient or _G.AutoQuestRace or Auto_Law or _G.AutoAllBoss or AutoTushita or
_G.AutoHolyTorch or _G.AutoTerrorshark or _G.farmpiranya or _G.DriveMytic or
_G.AutoCakeV2V2 or PirateShip or _G.AutoSeaBeast or _G.AutoNear or _G.BossRaid or
_G.GrabChest or AutoCitizen or _G.Ectoplasm or AutoEvoRace or AutoBartilo or AutoFactory
or BringChestz or BringFruitz or _G.AutoLevel or _G.Clip2 or AutoFarmNoQuest or
...
AutoSuperhuman or AutoSharkman or AutoElectricClaw or AutoDragonTalon or AutoGodhuman
or AutoRengoku or AutoBuddySword or AutoPole or AutoHallowSycthe or AutoCavander or
AutoTushita or AutoDarkDagger or _G.CakePrince or _G.AutoElite or AutoRainbowHaki or
AutoSaber or AutoFarmKen or AutoKenHop or AutoKenV2 or _G.AutoKillPlayerMelee or
...
L_276_.MaxForce = Vector3.new(100000, 100000,
100000)
...
if _G.TeleportIsland or _G.CastleRaid or AutoFarmChest or
_G.CollectAzure or _G.TweenToKitsune or _G.AutoCandy or _G.GhostShip or _G.Ship or
_G.SailBoat or _G.Auto_Holy_Torch or _G.Tweenfruit or _G.FindMirageIsland or _G.TeleportPly
or _G.AutoFishCrew or _G.AutoShark or _G.AutoMysticIsland or _G.AutoCakeV2 or
_G.AutoQuestRace or _G.AutoBuyBoat or _G.dao or AutoFarmAcient or _G.AutoMirage or
Auto_Law or _G.AutoQuestRace or _G.AutoAllBoss or _G.AutoHolyTorch or AutoTushita or
_G.farmpiranya or _G.AutoTerrorshark or _G.AutoNear or _G.AutoCakeV2V2 or PirateShip or
_G.AutoSeaBeast or _G.DriveMytic or _G.BossRaid or _G.GrabChest or AutoCitizen or
_G.Ectoplasm or AutoEvoRace or AutoBartilo or AutoFactory or BringChestz or BringFruitz or
_G.AutoLevel or _G.Clip2 or AutoFarmNoQuest or _G.AutoBone or
...
Auto_Quest_Tushita_2 or Auto_Quest_Tushita_3 or _G.Factory or _G.SwanGlasses or
AutoBartilo or AutoEvoRace or _G.Ectoplasm then
for L_277_forvar0, L_278_forvar1 in
pairs(game:GetService("Players").LocalPlayer.Character:GetDescendants()) do
...
for L_280_forvar0, L_281_forvar1 in
pairs(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("getInventory"))
do
...
if
L_290_forvar1.Parent:FindFirstChild("HumanoidRootPart") and not
L_288_[L_290_forvar1.Parent] then
table.insert(L_287_,
L_290_forvar1.Parent.HumanoidRootPart)
...
local L_295_ = (L_291_ * 798405 + L_293_ *
727595) % L_292_
local L_296_ = L_293_ * 798405
(function()
L_295_ = (L_295_ * L_292_ + L_296_) %
1099511627776
...
pcall(function()
if
L_88_.Character:FindFirstChildOfClass("Tool") and L_284_.blades and L_284_.blades[1] then
...
game.ReplicatedStorage.Remotes.Validator:FireServer(math.floor(L_295_ / 1099511627776 *
16777215), L_294_)
game:GetService("ReplicatedStorage").RigControllerEvent:FireServer("hit", L_286_,
L_285_forvar0, "")
end
end)
end
...
for L_301_forvar0, L_302_forvar1 in
pairs(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("getInventory"))
do
...
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame =
L_303_arg0
until (L_303_arg0.Position -
game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 2000
end
function BTP(L_304_arg0)
pcall(function()
if (L_304_arg0.Position -
game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude >= 2000 and not
Auto_Raid and game.Players.LocalPlayer.Character.Humanoid.Health > 0 then
...
for L_307_forvar0 , L_308_forvar1 in
pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
if L_308_forvar1.ToolTip == "Melee" then
if
game.Players.LocalPlayer.Backpack:FindFirstChild(tostring(L_308_forvar1.Name)) then
SelectWeapon =
L_308_forvar1.Name
end
end
...
for L_309_forvar0 , L_310_forvar1 in
pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
if L_310_forvar1.ToolTip == "Sword" then
if
game.Players.LocalPlayer.Backpack:FindFirstChild(tostring(L_310_forvar1.Name)) then
SelectWeapon =
L_310_forvar1.Name
end
end
...
for L_311_forvar0 , L_312_forvar1 in
pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
if L_312_forvar1.ToolTip == "Blox Fruit" then
if
game.Players.LocalPlayer.Backpack:FindFirstChild(tostring(L_312_forvar1.Name)) then
SelectWeapon =
L_312_forvar1.Name
end
end
...
for L_313_forvar0 , L_314_forvar1 in
pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
if L_314_forvar1.ToolTip == "Melee" then
if
game.Players.LocalPlayer.Backpack:FindFirstChild(tostring(L_314_forvar1.Name)) then
SelectWeapon =
L_314_forvar1.Name
end
end
...
CheckLevel()
if not
string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.
Title.Text, NameMon) or game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible
== false then
...
Title.Text, NameMon) or game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible
== true then
for L_316_forvar0, L_317_forvar1 in
pairs(game:GetService("Workspace").Enemies:GetChildren()) do
if L_317_forvar1:FindFirstChild("Humanoid")
and L_317_forvar1:FindFirstChild("HumanoidRootPart") and L_317_forvar1.Humanoid.Health >
0 then
...
FarmPos =
L_317_forvar1.HumanoidRootPart.CFrame
MonFarm =
L_317_forvar1.Name
--Click
until not _G.AutoLevel or not
L_317_forvar1.Parent or L_317_forvar1.Humanoid.Health <= 0 or not
game:GetService("Workspace").Enemies:FindFirstChild(L_317_forvar1.Name) or
game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == false
bringmob = false
end
end
end
for L_318_forvar0, L_319_forvar1 in
pairs(game:GetService("Workspace")["_WorldOrigin"].EnemySpawns:GetChildren()) do
if string.find(L_319_forvar1.Name,
NameMon) then
if
(game.Players.LocalPlayer.Character.HumanoidRootPart.Position -
L_319_forvar1.Position).Magnitude >= 10 then
...
local L_100_ = CFrame.new(- 16603.197265625, 130.3873748779297,
1087.16455078125)
spawn(function()
while wait() do
...
for L_321_forvar0, L_322_forvar1 in
pairs(game:GetService("Workspace").Enemies:GetChildren()) do
if L_322_forvar1.Name == "Isle Outlaw" or
L_322_forvar1.Name == "Island Boy" or L_322_forvar1.Name == "Sun-kissed Warrior" or
L_322_forvar1.Name == "Isle Champion" then
if
L_322_forvar1:FindFirstChild("Humanoid") and
L_322_forvar1:FindFirstChild("HumanoidRootPart") and L_322_forvar1.Humanoid.Health > 0
then
repeat
wait(_G.Fast_Delay)
AttackNoCD()
...
FarmPos =
L_322_forvar1.HumanoidRootPart.CFrame
MonFarm =
L_322_forvar1.Name
until not _G.AutoCandy or
not L_322_forvar1.Parent or L_322_forvar1.Humanoid.Health <= 0
bringmob = false
end
end
end
toTarget(CFrame.new(- 16599.1484375,
154.2681121826172, - 166.32186889648438))
end
end)
end
end
...
if _G.AutoNear then
pcall(function()
for L_324_forvar0, L_325_forvar1 in
pairs(game.Workspace.Enemies:GetChildren()) do
if L_325_forvar1:FindFirstChild("Humanoid") and
L_325_forvar1:FindFirstChild("HumanoidRootPart") and L_325_forvar1.Humanoid.Health > 0
then
if L_325_forvar1.Name then
if
(game.Players.LocalPlayer.Character.HumanoidRootPart.Position -
L_325_forvar1:FindFirstChild("HumanoidRootPart").Position).Magnitude <= 5000 then
repeat
wait(_G.Fast_Delay)
AttackNoCD()
bringmob = true
...
FarmPos =
L_325_forvar1.HumanoidRootPart.CFrame
MonFarm =
L_325_forvar1.Name
--Click
until not _G.AutoNear or not
L_325_forvar1.Parent or L_325_forvar1.Humanoid.Health <= 0 or not
game.Workspace.Enemies:FindFirstChild(L_325_forvar1.Name)
bringmob = false
end
end
end
...
pcall(function()
local L_327_ = CFrame.new(- 5496.17432, 313.768921, -
...
for L_328_forvar0, L_329_forvar1 in
pairs(game:GetService("Workspace").Enemies:GetChildren()) do
if _G.CastleRaid and
L_329_forvar1:FindFirstChild("HumanoidRootPart") and
L_329_forvar1:FindFirstChild("Humanoid") and L_329_forvar1.Humanoid.Health > 0 then
if
(L_329_forvar1.HumanoidRootPart.Position -
...
until
L_329_forvar1.Humanoid.Health <= 0 or not L_329_forvar1.Parent or not _G.CastleRaid
bringmob = false
end
end
end
...
if BypassTP then
if
(game.Players.LocalPlayer.Character.HumanoidRootPart.Position - L_327_.Position).Magnitude
> 2500 then
BTP(L_327_)
elseif
(game.Players.LocalPlayer.Character.HumanoidRootPart.Position - L_327_.Position).Magnitude
...
if
game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("God's Chalice") then
_G.chestsea3 = false
elseif not
game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("God's Chalice") then
if game:GetService("Workspace"):FindFirstChild("Chest1") then
TPchest(
game:GetService("Workspace"):FindFirstChild("Chest1").CFrame)
end
if game:GetService("Workspace"):FindFirstChild("Chest2") then
TPchest(
game:GetService("Workspace"):FindFirstChild("Chest2").CFrame)
end
if game:GetService("Workspace"):FindFirstChild("Chest3") then
TPchest(
game:GetService("Workspace"):FindFirstChild("Chest3").CFrame)
end
end
end
end)
...
if game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Fist
of Darkness") then
game:GetService("VirtualInputManager"):SendKeyEvent(true, "Q",
false, game)
_G.chestsea2 = false
elseif not
...
local L_331_ = (L_330_arg0.Position -
game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude
if L_331_ >= 0 then
Speed = 1200000
end
local L_332_ =
game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRoot
Part, TweenInfo.new(L_331_ / Speed), {
CFrame = L_330_arg0
})
L_332_:Play()
end
...
for L_338_forvar0, L_339_forvar1 in
pairs(game:GetService("Workspace"):GetChildren()) do
if L_339_forvar1.Name:find("Chest") then
if
game:GetService("Workspace"):FindFirstChild(L_339_forvar1.Name) then
if (L_339_forvar1.Position -
game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 5000 +
...
until AutoFarmChest == false or not
L_339_forvar1.Parent
...
if L_347_forvar1:IsA("Part") or L_347_forvar1:IsA("Union") or
L_347_forvar1:IsA("CornerWedgePart") or L_347_forvar1:IsA("TrussPart") then
L_347_forvar1.Material = "Plastic"
L_347_forvar1.Reflectance = 0
elseif L_347_forvar1:IsA("Decal") or L_347_forvar1:IsA("Texture") and
L_341_ then
L_347_forvar1.Transparency = 1
elseif L_347_forvar1:IsA("ParticleEmitter") or L_347_forvar1:IsA("Trail")
then
...
elseif L_347_forvar1:IsA("Fire") or L_347_forvar1:IsA("SpotLight") or
L_347_forvar1:IsA("Smoke") or L_347_forvar1:IsA("Sparkles") then
...
if L_349_forvar1:IsA("BlurEffect") or L_349_forvar1:IsA("SunRaysEffect")
or L_349_forvar1:IsA("ColorCorrectionEffect") or L_349_forvar1:IsA("BloomEffect") or
L_349_forvar1:IsA("DepthOfFieldEffect") then
...
pcall(function()
if _G.UseSkill then
for L_354_forvar0, L_355_forvar1 in
pairs(game:GetService("Workspace").Enemies:GetChildren()) do
if L_355_forvar1.Name == MonFarm and
L_355_forvar1:FindFirstChild("Humanoid") and
L_355_forvar1:FindFirstChild("HumanoidRootPart") and L_355_forvar1.Humanoid.Health <=
L_355_forvar1.Humanoid.MaxHealth * KillPercent / 100 then
repeat
...
if
game:GetService("Players").LocalPlayer.Character:FindFirstChild(game.Players.LocalPlayer.Da
ta.DevilFruit.Value) then
game:GetService("Players").LocalPlayer.Character:FindFirstChild(game.Players.LocalPlayer.Da
ta.DevilFruit.Value).MousePos.Value = PositionSkillMasteryDevilFruit
local L_356_ =
game:GetService("Players").LocalPlayer.Character:FindFirstChild(game.Players.LocalPlayer.Da
ta.DevilFruit.Value).Level.Value
if SkillZ and L_356_
>= 1 then
game:service('VirtualInputManager'):SendKeyEvent(true, "Z", false, game)
wait(0.1)
game:service('VirtualInputManager'):SendKeyEvent(false, "Z", false, game)
end
if SkillX and L_356_
>= 2 then
game:service('VirtualInputManager'):SendKeyEvent(true, "X", false, game)
wait(0.2)
game:service('VirtualInputManager'):SendKeyEvent(false, "X", false, game)
end
if SkillC and L_356_
>= 3 then
game:service('VirtualInputManager'):SendKeyEvent(true, "C", false, game)
wait(0.3)
game:service('VirtualInputManager'):SendKeyEvent(false, "C", false, game)
end
if SkillV and L_356_
>= 4 then
game:service('VirtualInputManager'):SendKeyEvent(true, "V", false, game)
wait(0.4)
game:service('VirtualInputManager'):SendKeyEvent(false, "V", false, game)
end
if SkillF and L_356_
>= 5 then
...
until not AutoFarmMasDevilFruit or
not _G.UseSkill or L_355_forvar1.Humanoid.Health == 0
end
end
end
end)
...
Title.Text, NameMon) or game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible
== true then
for L_357_forvar0, L_358_forvar1 in
pairs(game:GetService("Workspace").Enemies:GetChildren()) do
if L_358_forvar1:FindFirstChild("Humanoid")
and L_358_forvar1:FindFirstChild("HumanoidRootPart") then
if L_358_forvar1.Name == Ms then
repeat
game:GetService("RunService").Heartbeat:wait()
if
L_358_forvar1.Humanoid.Health <= L_358_forvar1.Humanoid.MaxHealth * KillPercent / 100
then
_G.UseSkill =
true
else
...
FarmPos =
L_358_forvar1.HumanoidRootPart.CFrame
MonFarm =
L_358_forvar1.Name
NormalAttack()
end
until not
AutoFarmMasDevilFruit or not L_358_forvar1.Parent or L_358_forvar1.Humanoid.Health == 0
or game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false or not
game:GetService("Workspace").Enemies:FindFirstChild(L_358_forvar1.Name) or not
TypeMastery == 'Level'
bringmob = false
_G.UseSkill = false
end
...
pcall(function()
for L_359_forvar0, L_360_forvar1 in
pairs(game.Workspace.Enemies:GetChildren()) do
if L_360_forvar1.Name and
L_360_forvar1:FindFirstChild("Humanoid") and
L_360_forvar1:FindFirstChild("HumanoidRootPart") then
if
(game.Players.LocalPlayer.Character.HumanoidRootPart.Position -
L_360_forvar1:FindFirstChild("HumanoidRootPart").Position).Magnitude <= 5000 then
repeat
game:GetService("RunService").Heartbeat:wait()
if
L_360_forvar1.Humanoid.Health <= L_360_forvar1.Humanoid.MaxHealth * KillPercent / 100
then
_G.UseSkill = true
else
_G.UseSkill = false
...
FarmPos =
L_360_forvar1.HumanoidRootPart.CFrame
MonFarm =
L_360_forvar1.Name
NormalAttack()
end
until not AutoFarmMasDevilFruit or
not MasteryType == 'Near Mobs' or not L_360_forvar1.Parent or
L_360_forvar1.Humanoid.Health == 0 or not TypeMastery == 'Near Mobs'
bringmob = false
_G.UseSkill = false
end
end
...
local L_363_ = CFrame.new(- 9359.453125, 141.32679748535156,
5446.81982421875)
spawn(function()
while wait() do
if _G.AutoBone then
...
if BypassTP then
if
(game.Players.LocalPlayer.Character.HumanoidRootPart.Position - L_363_.Position).Magnitude
> 2500 then
BTP(L_363_)
elseif
(game.Players.LocalPlayer.Character.HumanoidRootPart.Position - L_362_.Position).Magnitude
< 2500 then
Tween(L_362_)
end
else
...
for L_368_forvar0, L_369_forvar1 in
pairs(game:GetService("Workspace").Enemies:GetChildren()) do
if
L_369_forvar1:FindFirstChild("HumanoidRootPart") and
L_369_forvar1:FindFirstChild("Humanoid") and L_369_forvar1.Humanoid.Health > 0 then
if
L_369_forvar1.Name == "Reborn Skeleton" or L_369_forvar1.Name == "Living Zombie" or
L_369_forvar1.Name == "Demonic Soul" or L_369_forvar1.Name == "Posessed Mummy" then
if
string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.
...
until
not _G.AutoBone or L_369_forvar1.Humanoid.Health <= 0 or not L_369_forvar1.Parent or
...
pcall(function()
local L_371_ = CFrame.new(- 2142.66821,
71.2588654, - 12327.4619, 0.996939838, - 4.33107843e-08, 0.078172572, 4.20252917e-08, 1,
1.80894251e-08, - 0.078172572, - 1.47488439e-08, 0.996939838)
if BypassTP then
if
(game.Players.LocalPlayer.Character.HumanoidRootPart.Position - L_371_.Position).Magnitude
> 2000 then
BTP(L_371_)
wait(3)
elseif
...
for L_372_forvar0, L_373_forvar1 in
pairs(game:GetService("Workspace").Enemies:GetChildren()) do
if L_373_forvar1.Name ==
"Cake Prince" then
repeat
wait(_G.Fast_Delay)
AttackNoCD()
...
--Click
until _G.CakePrince
== false or not L_373_forvar1.Parent or L_373_forvar1.Humanoid.Health <= 0
bringmob = false
end
end
else
Tween(CFrame.new(-
2009.2802734375, 4532.97216796875, - 14937.3076171875))
end
else
if
...
for L_374_forvar0, L_375_forvar1 in
pairs(game:GetService("Workspace").Enemies:GetChildren()) do
if (L_375_forvar1.Name ==
"Baking Staff" or L_375_forvar1.Name == "Head Baker" or L_375_forvar1.Name == "Cake
Guard" or L_375_forvar1.Name == "Cookie Crafter") and L_375_forvar1.Humanoid.Health > 0
then
repeat
wait(_G.Fast_Delay)
AttackNoCD()
...
FarmPos =
L_375_forvar1.HumanoidRootPart.CFrame
MonFarm =
L_375_forvar1.Name
Tween(L_375_forvar1.HumanoidRootPart.CFrame * CFrame.new(posX, posY, posZ))
until _G.CakePrince
== false or game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince") or not
L_375_forvar1.Parent or L_375_forvar1.Humanoid.Health <= 0
bringmob = false
end
end
else
...
for L_379_forvar0, L_380_forvar1 in
pairs(game:GetService("Workspace").Enemies:GetChildren()) do
if L_380_forvar1.Name == "Ship
Steward" or L_380_forvar1.Name == "Ship Engineer" or L_380_forvar1.Name == "Ship
Deckhand" or L_380_forvar1.Name == "Ship Officer" and
L_380_forvar1:FindFirstChild("Humanoid") then
if
L_380_forvar1.Humanoid.Health > 0 then
repeat
wait(_G.Fast_Delay)
AttackNoCD()
AutoHaki()
...
FarmPos =
L_380_forvar1.HumanoidRootPart.CFrame
MonFarm =
L_380_forvar1.Name
--Click
until _G.Ectoplasm
== false or not L_380_forvar1.Parent or L_380_forvar1.Humanoid.Health == 0 or not
game:GetService("Workspace").Enemies:FindFirstChild(L_380_forvar1.Name)
bringmob = false
end
end
end
...
Tween(CFrame.new(904.4072265625,
...
for L_384_forvar0, L_385_forvar1 in
pairs(game:GetService("Workspace").Enemies:GetChildren()) do
if L_385_forvar1.Name == _G.SelectBoss
then
if
L_385_forvar1:FindFirstChild("Humanoid") and
L_385_forvar1:FindFirstChild("HumanoidRootPart") and L_385_forvar1.Humanoid.Health > 0
then
repeat
wait(_G.Fast_Delay)
AttackNoCD()
...
until not _G.AutoBoss or not
L_385_forvar1.Parent or L_385_forvar1.Humanoid.Health <= 0
bringmob = false
end
end
end
elseif
game.ReplicatedStorage:FindFirstChild(_G.SelectBoss) then
if
...
if
game:GetService("Workspace").Enemies:FindFirstChild(_G.SelectBoss) then
for L_386_forvar0, L_387_forvar1 in
pairs(game:GetService("Workspace").Enemies:GetChildren()) do
if L_387_forvar1.Name == _G.SelectBoss
then
if
L_387_forvar1:FindFirstChild("Humanoid") and
L_387_forvar1:FindFirstChild("HumanoidRootPart") and L_387_forvar1.Humanoid.Health > 0
then
repeat
wait(_G.Fast_Delay)
AttackNoCD()
...
sethiddenproperty(game:GetService("Players").LocalPlayer, "SimulationRadius", math.huge)
until not _G.AutoBoss or not
L_387_forvar1.Parent or L_387_forvar1.Humanoid.Health <= 0
bringmob = false
end
end
end
...
Tween(game:GetService("ReplicatedStorage"):FindFirstChild(_G.SelectBoss).HumanoidRootPa
rt.CFrame * CFrame.new(5, 10, 7))
end
end
end)
end
...
if
game:GetService("Workspace").Enemies:FindFirstChild(MMon) then
for L_390_forvar0, L_391_forvar1 in
pairs(game.Workspace.Enemies:GetChildren()) do
if L_391_forvar1:FindFirstChild("Humanoid")
and L_391_forvar1:FindFirstChild("HumanoidRootPart") and L_391_forvar1.Humanoid.Health >
0 then
if L_391_forvar1.Name == MMon
then
repeat
wait(_G.Fast_Delay)
AttackNoCD()
...
FarmPos =
L_391_forvar1.HumanoidRootPart.CFrame
MonFarm =
L_391_forvar1.Name
--Click
until not _G.AutoMaterial or
not L_391_forvar1.Parent or L_391_forvar1.Humanoid.Health <= 0
bringmob = false
end
end
end
else
for L_392_forvar0, L_393_forvar1 in
pairs(game:GetService("Workspace")["_WorldOrigin"].EnemySpawns:GetChildren()) do
if string.find(L_393_forvar1.Name, Mon)
then
if
(game.Players.LocalPlayer.Character.HumanoidRootPart.Position -
L_393_forvar1.Position).Magnitude >= 10 then
...
for L_399_forvar0, L_400_forvar1 in
pairs(game:GetService("Workspace").Map.KitsuneIsalnd.ShrineActive:GetChildren()) do
pcall(function()
if KitsuneEsp then
if L_400_forvar1.Name ~= "NeonShrinePart" then
if not
L_400_forvar1:FindFirstChild('IslandESP') then
local L_401_ =
Instance.new('BillboardGui', L_400_forvar1)
L_401_.Name = 'IslandESP'
L_401_.ExtentsOffset =
Vector3.new(0, 1, 0)
L_401_.Size = UDim2.new(1, 200, 1,
30)
L_401_.Adornee = L_400_forvar1
L_401_.AlwaysOnTop = true
local L_402_ =
Instance.new('TextLabel', L_401_)
L_402_.Font = "Code"
L_402_.FontSize = "Size14"
L_402_.TextWrapped = true
L_402_.Size = UDim2.new(1, 0, 1,
0)
L_402_.TextYAlignment = 'Top'
L_402_.BackgroundTransparency =
1
L_402_.TextStrokeTransparency =
0.5
L_402_.TextColor3 =
...
if L_405_ then
for L_406_forvar0, L_407_forvar1 in
pairs(L_405_:GetDescendants()) do
if L_407_forvar1:IsA("BasePart") and
L_407_forvar1.Name:find("NeonShrinePart") then
...
Tween(game:GetService("Workspace"):WaitForChild("EmberTemplate"):FindFirstChild("Part").C
Frame)
print("Azure")
end
end)
...
for L_421_forvar0,
L_422_forvar1 in pairs(game:GetService("Workspace").Boats:GetChildren()) do
if
L_422_forvar1.Name == "PirateGrandBrigade" then
repeat
wait()
if
(CFrame.new(- 17013.80078125, 10.962434768676758, 438.0169982910156).Position -
game.Players.LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 10 then
TweenShip(CFrame.new(- 33163.1875, 10.964323997497559, - 324.4842224121094))
elseif
(CFrame.new(- 33163.1875, 10.964323997497559, - 324.4842224121094).Position -
game.Players.LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 10 then
TweenShip(CFrame.new(- 37952.49609375, 10.96342945098877, - 1324.12109375))
elseif
(CFrame.new(- 37952.49609375, 10.96342945098877, - 1324.12109375).Position -
game.Players.LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 10 then
TweenShip(CFrame.new(- 33163.1875, 10.964323997497559, - 324.4842224121094))
end
until
...
game:GetService("Workspace").Enemies:FindFirstChild("Fish Crew Member") or _G.SailBoat
== false
end
end
end
...
for L_424_forvar0, L_425_forvar1 in
pairs(game:GetService("Workspace").Enemies:GetChildren()) do
if L_425_forvar1.Name ==
"Terrorshark" then
if
L_425_forvar1:FindFirstChild("Humanoid") and
L_425_forvar1:FindFirstChild("HumanoidRootPart") and L_425_forvar1.Humanoid.Health > 0
then
repeat
wait(_G.Fast_Delay)
AttackNoCD()
...
until not
_G.AutoTerrorshark or not L_425_forvar1.Parent or L_425_forvar1.Humanoid.Health <= 0
end
end
end
else
...
Tween(game:GetService("ReplicatedStorage"):FindFirstChild("Terrorshark").HumanoidRootPart.
...
for L_427_forvar0, L_428_forvar1 in
pairs(game:GetService("Workspace").Enemies:GetChildren()) do
if L_428_forvar1.Name == "Piranha"
then
if
L_428_forvar1:FindFirstChild("Humanoid") and
L_428_forvar1:FindFirstChild("HumanoidRootPart") and L_428_forvar1.Humanoid.Health > 0
then
repeat
wait(_G.Fast_Delay)
AttackNoCD()
...
until not
_G.farmpiranya or not L_428_forvar1.Parent or L_428_forvar1.Humanoid.Health <= 0
end
end
end
else
...
Tween(game:GetService("ReplicatedStorage"):FindFirstChild("Piranha").HumanoidRootPart.CF
rame * CFrame.new(2, 20, 2))
else
end
end
end)
...
for L_430_forvar0, L_431_forvar1 in
pairs(game:GetService("Workspace").Enemies:GetChildren()) do
if L_431_forvar1.Name == "Shark"
then
if
L_431_forvar1:FindFirstChild("Humanoid") and
L_431_forvar1:FindFirstChild("HumanoidRootPart") and L_431_forvar1.Humanoid.Health > 0
then
repeat
wait(_G.Fast_Delay)
AttackNoCD()
...
game.Players.LocalPlayer.Character.Humanoid.Sit = false
until not
_G.AutoShark or not L_431_forvar1.Parent or L_431_forvar1.Humanoid.Health <= 0
end
end
end
else
...
if
game:GetService("Workspace").Enemies:FindFirstChild("Fish Crew Member") then
for L_433_forvar0, L_434_forvar1 in
pairs(game:GetService("Workspace").Enemies:GetChildren()) do
if L_434_forvar1.Name == "Fish
Crew Member" then
if
L_434_forvar1:FindFirstChild("Humanoid") and
L_434_forvar1:FindFirstChild("HumanoidRootPart") and L_434_forvar1.Humanoid.Health > 0
then
repeat
wait(_G.Fast_Delay)
AttackNoCD()
...
game.Players.LocalPlayer.Character.Humanoid.Sit = false
until not
_G.AutoFishCrew or not L_434_forvar1.Parent or L_434_forvar1.Humanoid.Health <= 0
end
end
end
else
...
for L_437_forvar0, L_438_forvar1 in next,
game:GetService("Workspace").Enemies:GetChildren() do
if table.find(L_436_, L_438_forvar1.Name) and
L_438_forvar1:FindFirstChild("Health") and L_438_forvar1.Health.Value > 0 then
...
Skillaimbot = true
AutoSkill = false
until not L_439_ or not L_439_.Parent or
L_439_.Health.Value <= 0 or not CheckPirateBoat()
Skillaimbot = true
AutoSkill = false
end
end)
...
for L_442_forvar0, L_443_forvar1 in next,
game:GetService("Workspace").Enemies:GetChildren() do
if table.find(L_441_, L_443_forvar1.Name) and
L_443_forvar1:FindFirstChild("Health") and L_443_forvar1.Health.Value > 0 then
...
AimBotSkillPosition =
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame * CFrame.new(0, -5, 0)
until L_444_.Parent or L_444_.Health.Value
...
game:GetService("VirtualUser"):CaptureController()
game:GetService("VirtualUser"):Button1Down(Vector2.new(1280, 672))
for L_445_forvar0, L_446_forvar1 in
pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
if L_446_forvar1:IsA("Tool") then
if L_446_forvar1.ToolTip ==
"Melee" then -- "Blox Fruit" , "Sword" , "Wear" , "Agility"
...
game.Players.LocalPlayer.Character.HumanoidRootPart)
for L_447_forvar0, L_448_forvar1 in
pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
if L_448_forvar1:IsA("Tool") then
if L_448_forvar1.ToolTip ==
"Blox Fruit" then -- "Blox Fruit" , "Sword" , "Wear" , "Agility"
...
game.Players.LocalPlayer.Character.HumanoidRootPart)
wait(0.6)
for L_449_forvar0, L_450_forvar1 in
pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
if L_450_forvar1:IsA("Tool") then
if L_450_forvar1.ToolTip ==
"Sword" then -- "Blox Fruit" , "Sword" , "Wear" , "Agility"
...
game.Players.LocalPlayer.Character.HumanoidRootPart)
wait(0.5)
for L_451_forvar0, L_452_forvar1 in
pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
if L_452_forvar1:IsA("Tool") then
if L_452_forvar1.ToolTip ==
"Gun" then -- "Blox Fruit" , "Sword" , "Wear" , "Agility"
...
for L_454_forvar0,
L_455_forvar1 in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
if
L_455_forvar1:FindFirstChild("Humanoid") and
L_455_forvar1:FindFirstChild("HumanoidRootPart") and L_455_forvar1.Humanoid.Health > 0
then
if
L_455_forvar1.Name == "Diablo" or L_455_forvar1.Name == "Deandre" or
L_455_forvar1.Name == "Urban" then
repeat
wait(_G.Fast_Delay)
AttackNoCD()
EquipTool(SelectWeapon)
...
until
_G.AutoElite == false or L_455_forvar1.Humanoid.Health <= 0 or not L_455_forvar1.Parent
end
end
end
else
...
toTarget(game:GetService("ReplicatedStorage"):FindFirstChild("Diablo").HumanoidRootPart.CF
rame * CFrame.new(posX, posY, posZ))
elseif
game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") then
toTarget(game:GetService("ReplicatedStorage"):FindFirstChild("Deandre").HumanoidRootPart.
CFrame * CFrame.new(posX, posY, posZ))
elseif
game:GetService("ReplicatedStorage"):FindFirstChild("Urban") then
toTarget(game:GetService("ReplicatedStorage"):FindFirstChild("Urban").HumanoidRootPart.CFr
ame * CFrame.new(posX, posY, posZ))
end
end
end
else
...
if (CFrame.new(-
4513.90087890625, 16.76398277282715, - 2658.820556640625).Position -
game.Players.LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 10 then
if buyb then
buyb:Stop()
end
...
until
game:GetService("Workspace").SeaBeasts:FindFirstChild("SeaBeast1") or _G.AutoSeaBeast
== false
end
end
elseif
game:GetService("Workspace").Boats:FindFirstChild("PirateGrandBrigade") then
for L_467_forvar0,
L_468_forvar1 in pairs(game:GetService("Workspace").Boats:GetChildren()) do
if
L_468_forvar1.Name == "PirateGrandBrigade" then
if
L_468_forvar1:FindFirstChild("VehicleSeat") then
repeat
wait()
game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Sit = false
TweenBoat(L_468_forvar1.VehicleSeat.CFrame * CFrame.new(0, 1, 0))
until
not game:GetService("Workspace").Boats:FindFirstChild("PirateGrandBrigade") or
...
elseif
game:GetService("Workspace").Boats:FindFirstChild("PirateGrandBrigade") then
for L_469_forvar0, L_470_forvar1 in
pairs(game:GetService("Workspace").Boats:GetChildren()) do
if L_470_forvar1.Name ==
"PirateGrandBrigade" then
if
L_470_forvar1:FindFirstChild("VehicleSeat") then
repeat
wait()
game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Sit = false
...
elseif
game:GetService("Workspace").SeaBeasts:FindFirstChild("SeaBeast1") then
for L_471_forvar0, L_472_forvar1 in
pairs(game:GetService("Workspace").SeaBeasts:GetChildren()) do
if
L_472_forvar1:FindFirstChild("HumanoidRootPart") then
repeat
wait()
game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Sit = false
...
AutoSkill = true
AimBotSkillPosition =
L_472_forvar1.HumanoidRootPart
Skillaimbot = true
until not
L_472_forvar1:FindFirstChild("HumanoidRootPart") or _G.AutoSeaBeast == false
AutoSkill = false
Skillaimbot = false
end
end
...
Tween(CFrame.new(game:GetService("Workspace").Map.MysticIsland.Center.Position.X, 500,
...
if
game:GetService("Workspace").Map:FindFirstChild("MysticIsland") then
for L_476_forvar0, L_477_forvar1 in
pairs(game:GetService("Workspace").Map.MysticIsland:GetChildren()) do
if L_477_forvar1:IsA("MeshPart")
then
if L_477_forvar1.Material ==
...
local L_480_ =
game.Workspace.CurrentCamera.CFrame.p + L_479_ * 100
game.Workspace.CurrentCamera.CFrame =
CFrame.lookAt(game.Workspace.CurrentCamera.CFrame.p, L_480_)
end
end)
end
end)
...
for L_488_forvar0, L_489_forvar1 in
pairs(game:GetService("Workspace").Enemies:GetChildren()) do
if string.find(L_489_forvar1.Name,
"Soul Reaper") then
repeat
wait(_G.Fast_Delay)
AttackNoCD()
...
--Click
until
L_489_forvar1.Humanoid.Health <= 0 or AutoHallowSycthe == false
end
end
elseif
...
repeat
wait(.1)
fireclickdetector(game:GetService("Workspace").Map.Waterfall.SealedKatana.Handle.ClickDete
ctor)
until
game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Yama") or not _G.AutoYama
end
end
end
end)
...
for L_493_forvar0, L_494_forvar1 in
pairs(game:GetService("Workspace").Enemies:GetChildren()) do
if L_494_forvar1.Name == ("Longma" or
L_494_forvar1.Name == "Longma") and L_494_forvar1.Humanoid.Health > 0 and
L_494_forvar1:IsA("Model") and L_494_forvar1:FindFirstChild("Humanoid") and
L_494_forvar1:FindFirstChild("HumanoidRootPart") then
repeat
wait(_G.Fast_Delay)
AttackNoCD()
AutoHaki()
...
FarmPos =
L_494_forvar1.HumanoidRootPart.CFrame
--Click
...
L_494_forvar1.Parent or L_494_forvar1.Humanoid.Health <= 0
end
end
else
...
(game.Players.LocalPlayer.Character.HumanoidRootPart.Position - Vector3.new(-10752, 417,
-9366)).Magnitude <= 10
wait(1)
repeat
...
wait()
until not _G.Auto_Holy_Torch or
(game.Players.LocalPlayer.Character.HumanoidRootPart.Position - Vector3.new(-11672, 334,
-9474)).Magnitude <= 10
wait(1)
repeat
...
wait()
until not _G.Auto_Holy_Torch or
(game.Players.LocalPlayer.Character.HumanoidRootPart.Position - Vector3.new(-12132, 521,
-10655)).Magnitude <= 10
wait(1)
repeat
...
wait()
until not _G.Auto_Holy_Torch or
(game.Players.LocalPlayer.Character.HumanoidRootPart.Position - Vector3.new(-13336, 486,
-6985)).Magnitude <= 10
wait(1)
repeat
...
wait()
until not _G.Auto_Holy_Torch or
(game.Players.LocalPlayer.Character.HumanoidRootPart.Position - Vector3.new(-13489, 332,
-7925)).Magnitude <= 10
end)
end
end
...
for L_498_forvar0, L_499_forvar1 in
pairs(game.Workspace.Enemies:GetChildren()) do
if L_499_forvar1.Name == "Core" and
L_499_forvar1.Humanoid.Health > 0 then
repeat
wait(_G.Fast_Delay)
AttackNoCD()
repeat
...
(game.Players.LocalPlayer.Character.HumanoidRootPart.Position - Vector3.new(448.46756,
199.356781, - 441.389252)).Magnitude <= 10
EquipTool(SelectWeapon)
AutoHaki()
...
FarmPos =
L_499_forvar1.HumanoidRootPart.CFrame
MonFarm = L_499_forvar1.Name
--Click
until not L_499_forvar1.Parent or
L_499_forvar1.Humanoid.Health <= 0 or _G.Factory == false
end
end
...
King") then
for L_502_forvar0, L_503_forvar1 in
pairs(game:GetService("Workspace").Enemies:GetChildren()) do
if L_503_forvar1.Name == "Dough King" then
if L_503_forvar1:FindFirstChild("Humanoid")
and L_503_forvar1:FindFirstChild("HumanoidRootPart") and L_503_forvar1.Humanoid.Health >
0 then
repeat
wait(_G.Fast_Delay)
AttackNoCD()
...
until not _G.AutoCakeV2 or not
L_503_forvar1.Parent or L_503_forvar1.Humanoid.Health <= 0
end
end
end
else
...
while wait() do
pcall(function()
for L_512_forvar0, L_513_forvar1 in
pairs(game:GetService("Workspace").Enemies:GetChildren()) do
if _G.BringMob and bringmob then
if L_513_forvar1.Name == MonFarm and
L_513_forvar1:FindFirstChild("Humanoid") and L_513_forvar1.Humanoid.Health > 0 then
if L_513_forvar1.Name == "Factory Staff" then
if
(L_513_forvar1.HumanoidRootPart.Position - FarmPos.Position).Magnitude <= 500 then
L_513_forvar1.Head.CanCollide =
false
...
if
L_513_forvar1.Humanoid:FindFirstChild("Animator") then
...
if
(L_513_forvar1.HumanoidRootPart.Position - FarmPos.Position).Magnitude <= 450 then
L_513_forvar1.Head.CanCollide =
false
L_513_forvar1.HumanoidRootPart.CanCollide = false
L_513_forvar1.HumanoidRootPart.Size = Vector3.new(1, 1, 1)
...
spawn(function()
while wait() do
for L_550_forvar0, L_551_forvar1 in
pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
...
for L_552_forvar0, L_553_forvar1 in
...
AimBotSkillPosition =
game.Players:FindFirstChild(SelectPlayer).Character:FindFirstChild("HumanoidRootPart").Positi
on
end
end
end
...
(game:GetService("Players"):FindFirstChild(SelectPlayer).Character.HumanoidRootPart.Positio
n - tool.Handle.CFrame.p)
.unit * 100), {
game.Players.LocalPlayer.Character,
workspace._WorldOrigin
});
game:GetService("Players").LocalPlayer.Character[SelectToolWeaponGun].RemoteFunctionSh
oot:InvokeServer(
...
toTarget(CFrame.new(- 5247.7163085938, 12.883934020996,
8504.96875))
...
BTPZ(CFrame.new(- 483.73370361328, 332.0383605957,
595.32708740234))
...
toTarget(CFrame.new(923.40197753906, 125.05712890625,
32885.875))
...
toTarget(CFrame.new(- 290.7376708984375,
...
"Bomb-Bomb", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Bomb Fruit"))
end
if
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit",
"Spike-Spike", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Spike Fruit"))
end
if
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit",
"Chop-Chop", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Chop Fruit"))
end
if
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit",
"Spring-Spring", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Spring
Fruit"))
end
if
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit",
"Rocket-Rocket", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Kilo Fruit"))
end
if
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit",
"Smoke-Smoke", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Smoke
Fruit"))
end
if
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit",
"Spin-Spin", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Spin Fruit"))
end
if
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit",
"Flame-Flame", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Flame
Fruit"))
end
if
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit",
"Bird-Bird: Falcon", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Bird:
Falcon Fruit"))
end
if
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit",
"Sand-Sand", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Sand Fruit"))
end
if
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit",
"Dark-Dark", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dark Fruit"))
end
if
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit",
"Ghost-Ghost", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Revive
Fruit"))
end
if
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit",
"Light-Light", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Light Fruit"))
end
if
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit",
"Love-Love", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Love Fruit"))
end
if
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit",
"Rubber-Rubber", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Rubber
Fruit"))
end
if
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit",
"Barrier-Barrier", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Barrier
Fruit"))
end
if
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit",
"Magma-Magma", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Magma
Fruit"))
end
if
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit",
"Door-Door", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Portal Fruit"))
end
if
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit",
"Quake-Quake", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Quake
Fruit"))
end
if
game:GetService("Players").LocalPlayer.Character:FindFirstChild("Human-Human: Buddha
Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Human-Human:
Buddha Fruit") then
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit",
"Human-Human: Buddha",
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit",
"Spider-Spider", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Spider
Fruit"))
end
if
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit",
"Bird-Bird: Phoenix", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Bird:
Phoenix Fruit"))
end
if
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit",
"Rumble-Rumble", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Rumble
Fruit"))
end
if
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit",
"Pain-Pain", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Paw Fruit"))
end
if
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit",
"Gravity-Gravity", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Gravity
Fruit"))
end
if
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit",
"Dough-Dough", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dough
Fruit"))
end
if
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit",
"Shadow-Shadow", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Shadow
Fruit"))
end
if
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit",
"Venom-Venom", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Venom
Fruit"))
end
if
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit",
"Control-Control", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Control
Fruit"))
end
if
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit",
"Soul-Soul", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Spirit Fruit"))
end
if
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit",
"Dragon-Dragon", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon
Fruit"))
if
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit",
"Leopard-Leopard", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Leopard
Fruit"))
end
end
end
...
for L_563_forvar0, L_564_forvar1 in
pairs(game.Workspace:GetChildren()) do
...
if
game:GetService("Players")["LocalPlayer"].PlayerGui.Main.Timer.Visible == false then
if not
game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 1") and
...
if KillAura then
pcall(function()
for L_574_forvar0, L_575_forvar1 in
pairs(game.Workspace.Enemies:GetDescendants()) do
if L_575_forvar1:FindFirstChild("Humanoid") and
L_575_forvar1:FindFirstChild("HumanoidRootPart") and L_575_forvar1.Humanoid.Health > 0
then
repeat
task.wait()
sethiddenproperty(game:GetService('Players').LocalPlayer, "SimulationRadius", math.huge)
...
until not KillAura or not L_575_forvar1.Parent or
L_575_forvar1.Humanoid.Health <= 0
end
end
end)
...
if Auto_Law then
if not
game:GetService("Players").LocalPlayer.Character:FindFirstChild("Microchip") and not
...
fireclickdetector(game:GetService("Workspace").Map.CircleIsland.RaidSummon.Button.Main.Cli
ckDetector)
end
end
...
for L_597_forvar0, L_598_forvar1 in
pairs(game:GetService("Workspace").Enemies:GetChildren()) do
...
--Click
until not L_598_forvar1.Parent or
L_598_forvar1.Humanoid.Health <= 0 or Auto_Law == false
end
end
elseif
game:GetService("ReplicatedStorage"):FindFirstChild("Order") then
Tween(CFrame.new(- 6217.2021484375,
28.047645568848, - 5053.1357421875))
end
end
end
...
Description = "",
Callback = function()
Tween2(CFrame.new(28575.181640625, 14936.6279296875,
72.31636810302734))
end
})
L_5_.Race:AddButton({
...
Description = "",
Callback = function()
Tween2(CFrame.new(28981.552734375, 14888.4267578125, -
120.245849609375))
end
})
...
235.03948974609375))
elseif game:GetService("Players").LocalPlayer.Data.Race.Value == "Fishman"
then
...
"Human" then
for L_601_forvar0, L_602_forvar1 in
pairs(game.Workspace.Enemies:GetDescendants()) do
if L_602_forvar1:FindFirstChild("Humanoid") and
L_602_forvar1:FindFirstChild("HumanoidRootPart") and L_602_forvar1.Humanoid.Health > 0
then
pcall(function()
repeat
wait(.1)
...
L_602_forvar1.Parent or L_602_forvar1.Humanoid.Health <= 0
end)
end
end
elseif game:GetService("Players").LocalPlayer.Data.Race.Value
== "Skypiea" then
for L_603_forvar0, L_604_forvar1 in
pairs(game:GetService("Workspace").Map.SkyTrial.Model:GetDescendants()) do
if L_604_forvar1.Name ==
"snowisland_Cylinder.081" then
BTPZ(L_604_forvar1.CFrame *
CFrame.new(0, 0, 0))
end
end
elseif game:GetService("Players").LocalPlayer.Data.Race.Value
== "Fishman" then
for L_605_forvar0, L_606_forvar1 in
pairs(game:GetService("Workspace").SeaBeasts.SeaBeast1:GetDescendants()) do
if L_606_forvar1.Name == "HumanoidRootPart"
then
Tween(L_606_forvar1.CFrame * L_21_)
for L_607_forvar0, L_608_forvar1 in
pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
if L_608_forvar1:IsA("Tool") then
if L_608_forvar1.ToolTip ==
"Melee" then
...
game:GetService("VirtualInputManager"):SendKeyEvent(false, 99, false,
game.Players.LocalPlayer.Character.HumanoidRootPart)
for L_609_forvar0, L_610_forvar1 in
pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
if L_610_forvar1:IsA("Tool") then
if L_610_forvar1.ToolTip ==
"Blox Fruit" then
...
game.Players.LocalPlayer.Character.HumanoidRootPart)
wait(0.5)
for L_611_forvar0, L_612_forvar1 in
pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
if L_612_forvar1:IsA("Tool") then
if L_612_forvar1.ToolTip ==
"Sword" then
...
game.Players.LocalPlayer.Character.HumanoidRootPart)
wait(0.5)
for L_613_forvar0, L_614_forvar1 in
pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
if L_614_forvar1:IsA("Tool") then
if L_614_forvar1.ToolTip ==
"Gun" then
...
elseif game:GetService("Players").LocalPlayer.Data.Race.Value
== "Cyborg" then
Tween(CFrame.new(28654, 14898.7832, -30, 1, 0, 0, 0, 1,
0, 0, 0, 1))
elseif game:GetService("Players").LocalPlayer.Data.Race.Value
== "Ghoul" then
for L_615_forvar0, L_616_forvar1 in
pairs(game.Workspace.Enemies:GetDescendants()) do
if L_616_forvar1:FindFirstChild("Humanoid") and
L_616_forvar1:FindFirstChild("HumanoidRootPart") and L_616_forvar1.Humanoid.Health > 0
then
pcall(function()
repeat
wait(.1)
...
sethiddenproperty(game.Players.LocalPlayer, "SimulationRadius", math.huge)
until not _G.AutoQuestRace or not
L_616_forvar1.Parent or L_616_forvar1.Humanoid.Health <= 0
end)
end
end
elseif game:GetService("Players").LocalPlayer.Data.Race.Value
== "Mink" then
for L_617_forvar0, L_618_forvar1 in
pairs(game:GetService("Workspace"):GetDescendants()) do
if L_618_forvar1.Name == "StartPoint" then
Tween(L_618_forvar1.CFrame *
CFrame.new(0, 10, 0))
end
end
end
...
toTarget(CFrame.new(216.211181640625,
...
Warrior") or game:GetService("Workspace").Enemies:FindFirstChild("Chocolate Bar Battler") or
...
for L_620_forvar0, L_621_forvar1 in
pairs(game:GetService("Workspace").Enemies:GetChildren()) do
if L_621_forvar1.Name == "Cocoa Warrior" or
L_621_forvar1.Name == "Chocolate Bar Battler" or L_621_forvar1.Name == "Sweet Thief" or
L_621_forvar1.Name == "Candy Rebel" then
if L_621_forvar1:FindFirstChild("Humanoid")
and L_621_forvar1:FindFirstChild("HumanoidRootPart") and L_621_forvar1.Humanoid.Health >
0 then
bringmob = true
repeat
wait(_G.Fast_Delay)
...
FarmPos =
L_621_forvar1.HumanoidRootPart.CFrame
MonFarm =
L_621_forvar1.Name
Tween(L_621_forvar1.HumanoidRootPart.CFrame * CFrame.new(posX, posY, posZ))
until not AutoFarmAcient or not
L_621_forvar1.Parent or L_621_forvar1.Humanoid.Health <= 0
bringmob = false
end
end
end
...
if L_626_ == "" then
L_629_ =
game.HttpService:JSONDecode(game:HttpGet('https://games.roblox.com/v1/games/' .. L_624_
.. '/servers/Public?sortOrder=Asc&limit=100'))
else
L_629_ =
game.HttpService:JSONDecode(game:HttpGet('https://games.roblox.com/v1/games/' .. L_624_
.. '/servers/Public?sortOrder=Asc&limit=100&cursor=' .. L_626_))
end
local L_630_ = ""
if L_629_.nextPageCursor and L_629_.nextPageCursor ~= "null" and
L_629_.nextPageCursor ~= nil then
...
if tonumber(L_633_forvar1.maxPlayers) >
tonumber(L_633_forvar1.playing) then
...
if tonumber(L_627_) ~= tonumber(L_636_forvar1)
then
...
pcall(function()
wait()
game:GetService("TeleportService"):TeleportToPlaceInstance(L_624_, L_630_,
...
Callback = function()
for L_639_forvar0, L_640_forvar1 in
pairs(game:GetObjects("rbxassetid://14759368201")[1]:GetChildren()) do
L_640_forvar1.Parent = game.Workspace.Map
L_640_forvar1:MoveTo(game.Players.LocalPlayer.Character.PrimaryPart.Position +
Vector3.new(math.random(-50, 50), 100, math.random(-50, 50)))
if L_640_forvar1.Fruit:FindFirstChild("AnimationController") then
L_640_forvar1.Fruit:FindFirstChild("AnimationController"):LoadAnimation(L_640_forvar1.Fruit:Fi
ndFirstChild("Idle")):Play()
end
L_640_forvar1.Handle.Touched:Connect(function(L_641_arg0)
if L_641_arg0.Parent == game.Players.LocalPlayer.Character
then
L_640_forvar1.Parent =
...
getgenv().rejoin =
game:GetService("CoreGui").RobloxPromptGui.promptOverlay.ChildAdded:Connect(function(L_
643_arg0)
if L_643_arg0.Name == 'ErrorPrompt' and
L_643_arg0:FindFirstChild('MessageArea') and
L_643_arg0.MessageArea:FindFirstChild("ErrorFrame") then
game:GetService("TeleportService"):Teleport(game.PlaceId)
end
end)
end
...
L_645_:Create(
L_649_, TweenInfo.new(.4, Enum.EasingStyle.Back,
...
local L_655_ =
require(game:GetService("Players").LocalPlayer.PlayerGui.Main.UIController.Inventory)
local L_656_ =
...
game:GetService("Players").LocalPlayer.PlayerGui.Main.InventoryContainer.Right.Content.Scro
llingFrame.CanvasPosition = Vector2.new(0, L_681_)
for L_682_forvar0, L_683_forvar1 in
pairs(game:GetService("Players").LocalPlayer.PlayerGui.Main.InventoryContainer.Right.Content
.ScrollingFrame.Frame:GetChildren()) do
if L_683_forvar1:IsA("Frame") and not
L_661_[L_683_forvar1.ItemName.Text] and L_683_forvar1.ItemName.Visible == true then
local L_684_ =
GetRaity(L_683_forvar1.Background.BackgroundColor3)
if L_684_ then
if not L_662_[L_684_] then
L_662_[L_684_] = {}
end
table.insert(L_662_[L_684_],
L_683_forvar1:Clone())
end
L_663_ = L_663_ + 1
...
local L_665_ = Instance.new("Frame",
...
local L_666_ = Instance.new("Frame",
game.Players.LocalPlayer.PlayerGui.BubbleChat)
...
if L_657_[L_693_forvar1.ItemName.Text] and
L_657_[L_693_forvar1.ItemName.Text].Mastery then
...
L_694_.ZIndex = 5
L_694_.Text =
L_657_[L_693_forvar1.ItemName.Text].Mastery
...
if L_667_[L_696_forvar1] and
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy" ..
L_696_forvar1, true) == 1 then
...
return tostring(L_698_arg0):reverse():gsub("%d%d%d",
"%1,"):reverse():gsub("^,", "")
end
...
for L_699_forvar0, L_700_forvar1 in
...
pcall(function()
game:GetService("Players").LocalPlayer.PlayerGui.Main.Compass.Visible
= false
end)
end
})
...
"http://www.roblox.com/asset/?id=9709149052" or
...
SubContent = "", -- Optional
Duration = 5 -- Set to nil to make the notification not
disappear
})
elseif game:GetService("Lighting").Sky.MoonTextureId ==
...
Tween(getHighestPoint().CFrame * CFrame.new(0,
211.88, 0))
end
elseif not
game:GetService("Workspace").Map:FindFirstChild("MysticIsland") or not
game:GetService("Workspace").Map:FindFirstChild("MysticIsland") then
Hop()
end
end
